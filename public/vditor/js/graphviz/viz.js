    ...
    createClass(Viz, [
      ...
      },
      {
        ...
        value: function renderSVGElement(src) {
          ...
          return this.renderString(src, _extends({}, options, { format: 'svg' })).then(
            function (str) {
      ...
      },
      {
        ...
        value: function renderImageElement(src) {
          ...
          return this.renderString(src, _extends({}, options, { format: 'svg' })).then(
            function (str) {
              if (
                (typeof fabric === 'undefined' ? 'undefined' : _typeof(fabric)) === 'object' &&
      ...
      },
      {
        ...
        value: function renderJSONObject(src) {
          ...
          return this.renderString(src, _extends({}, options, { format: format })).then(
            function (str) {
