!(function (t, e) {
  if ('object' == typeof exports && 'object' == typeof module) module.exports = e(require('katex'))
  else if ('function' == typeof define && define.amd) define(['katex'], e)
  else {
    var n = 'object' == typeof exports ? e(require('katex')) : e(t.katex)
  ...
  return (function () {
    ...
    return (
      (function () {
        var t = o(771),
          e = o.n(t)
        ;(e().__defineMacro('\\ce', function (t) {
          return n(t.consumeArgs(1)[0], 'ce')
        }),
          e().__defineMacro('\\pu', function (t) {
            return n(t.consumeArgs(1)[0], 'pu')
          }),
          e().__defineMacro(
            '\\tripledash',
        ...
        var n = function (t, e) {
            for (
              var n = '', o = t.length && t[t.length - 1].loc.start, i = t.length - 1;
              i >= 0;
              i--
            )
              (t[i].loc.start > o && ((n += ' '), (o = t[i].loc.start)),
                (n += t[i].text),
                (o += t[i].text.length))
            return r.go(a.go(n, e))
          },
          a = {
            go: function (t, e) {
              if (!t) return []
              ...
              for (var i = 10, c = []; ;) {
                n !== t ? ((i = 10), (n = t)) : i--
                var u = a.stateMachines[e],
                  p = u.transitions[o] || u.transitions['*']
                t: for (var s = 0; s < p.length; s++) {
                  var _ = a.patterns.match_(p[s].pattern, t)
                  if (_) {
                    for (var d = p[s].task, m = 0; m < d.action_.length; m++) {
                      var l
                      if (u.actions[d.action_[m].type_])
                        l = u.actions[d.action_[m].type_](r, _.match_, d.action_[m].option)
                      else {
                        if (!a.actions[d.action_[m].type_])
                          throw [
                            'MhchemBugA',
                            'mhchem bug A. Please report. (' + d.action_[m].type_ + ')',
                          ]
                        l = a.actions[d.action_[m].type_](r, _.match_, d.action_[m].option)
                      }
                      a.concatArray(c, l)
                    }
            ...
            concatArray: function (t, e) {
              if (e)
                if (Array.isArray(e)) for (var n = 0; n < e.length; n++) t.push(e[n])
                else t.push(e)
            },
            patterns: {
              patterns: {
                ...
                amount: function (t) {
                  ...
                  var n = a.patterns.findObserveGroups(t, '', '$', '$', '')
                  return n &&
                    (e = n.match_.match(
              ...
              findObserveGroups: function (t, e, n, o, a, r, i, c, u, p) {
                var s = function (t, e) {
                ...
                if (((t = t.substr(_.length)), null === (_ = s(t, n)))) return null
                ...
                var m = t.substring(0, o ? d.endMatchEnd : d.endMatchBegin)
                if (r || i) {
                  var l = this.findObserveGroups(t.substr(d.endMatchEnd), r, i, c, u)
                  if (null === l) return null
                  var f = [m, l.match_]
                  return { match_: p ? f.join('') : f, remainder: l.remainder }
                }
                return { match_: m, remainder: t.substr(d.endMatchEnd) }
              },
              match_: function (t, e) {
                var n = a.patterns.patterns[t]
                if (void 0 === n) throw ['MhchemBugP', 'mhchem bug P. Please report. (' + t + ')']
                if ('function' == typeof n) return a.patterns.patterns[t](e)
                var o = e.match(n)
                return o
                  ? {
            ...
            actions: {
              ...
              '{text}': function (t, e) {
                var n = ['{']
                return (a.concatArray(n, a.go(e, 'text')), n.push('}'), n)
              },
              ...
              '1/2': function (t, e) {
                ...
                var o = e.match(/^([0-9]+|\$[a-z]\$|[a-z])\/([0-9]+)(\$[a-z]\$|[a-z])?$/)
                return (
                  (o[1] = o[1].replace(/\$/g, '')),
                  n.push({ type_: 'frac', p1: o[1], p2: o[2] }),
                  o[3] &&
                    ((o[3] = o[3].replace(/\$/g, '')), n.push({ type_: 'tex-math', p1: o[3] })),
                  n
                )
              },
              '9,9': function (t, e) {
            ...
            createTransitions: function (t) {
              ...
              for (e in t)
                for (n in t[e])
                  for (o = n.split('|'), t[e][n].stateArray = o, a = 0; a < o.length; a++)
                    r[o[a]] = []
              for (e in t)
                for (n in t[e])
                  for (o = t[e][n].stateArray || [], a = 0; a < o.length; a++) {
                    var i = t[e][n]
                    if (i.action_) {
                    ...
                    for (var u = e.split('|'), p = 0; p < u.length; p++)
                      if ('*' === o[a]) for (var s in r) r[s].push({ pattern: u[p], task: i })
                      else r[o[a]].push({ pattern: u[p], task: i })
                  }
              return r
            },
            stateMachines: {},
          ...
          ce: {
            ...
            actions: {
              'o after d': function (t, e) {
                ...
                if ((t.d || '').match(/^[0-9]+$/)) {
                  var o = t.d
                  ;((t.d = void 0), (n = this.output(t)), (t.b = o))
                } else n = this.output(t)
                return (a.actions['o='](t, e), n)
              },
              'd= kv': function (t, e) {
                ;((t.d = e), (t.dType = 'kv'))
              },
              'charge or bond': function (t, e) {
                if (t.beginsWithBond) {
                  var n = []
                  return (
                    a.concatArray(n, this.output(t)), a.concatArray(n, a.actions.bond(t, e, '-')), n
                  )
                }
                t.d = e
              },
              '- after o/d': function (t, e, n) {
                var o = a.patterns.match_('orbital', t.o || ''),
                  r = a.patterns.match_('one lowercase greek letter $', t.o || ''),
                  i = a.patterns.match_('one lowercase latin letter $', t.o || ''),
                  c = a.patterns.match_('$one lowercase latin letter$ $', t.o || ''),
                  u = '-' === e && ((o && '' === o.remainder) || r || i || c)
                !u || t.a || t.b || t.p || t.d || t.q || o || !i || (t.o = '$' + t.o + '$')
                var p = []
                return (
                  u
                    ? (a.concatArray(p, this.output(t)), p.push({ type_: 'hyphen' }))
                    : ((o = a.patterns.match_('digits', t.d || '')),
                      n && o && '' === o.remainder
                        ? (a.concatArray(p, a.actions['d='](t, e)),
                          a.concatArray(p, this.output(t)))
                        : (a.concatArray(p, this.output(t)),
                          a.concatArray(p, a.actions.bond(t, e, '-')))),
                  p
                )
              },
              'a to o': function (t) {
              ...
              comma: function (t, e) {
                var n = e.replace(/\s*$/, '')
                return n !== e && 0 === t.parenthesisLevel
              ...
              output: function (t, e, n) {
                ...
                t.r
                  ...
                  : ((o = []),
                    (t.a || t.b || t.p || t.o || t.q || t.d || n) &&
                      (t.sb && o.push({ type_: 'entitySkip' }),
                      t.o || t.q || t.d || t.b || t.p || 2 === n
                        ? t.o || t.q || t.d || (!t.b && !t.p)
              ...
              'oxidation-output': function (t, e) {
                var n = ['{']
                return (a.concatArray(n, a.go(e, 'oxidation')), n.push('}'), n)
              },
          ...
          pu: {
            ...
            actions: {
              enumber: function (t, e) {
                var n = []
                return (
                  '+-' === e[0] || '+/-' === e[0] ? n.push('\\pm ') : e[0] && n.push(e[0]),
                  e[1] &&
                    (a.concatArray(n, a.go(e[1], 'pu-9,9')),
                    e[2] &&
                      (e[2].match(/[,.]/) ? a.concatArray(n, a.go(e[2], 'pu-9,9')) : n.push(e[2])),
                    (e[3] = e[4] || e[3]),
                    e[3] &&
                      ((e[3] = e[3].trim()),
              ...
              output: function (t) {
                var e,
                  n = a.patterns.match_('{(...)}', t.d || '')
                n && '' === n.remainder && (t.d = n.match_)
                var o = a.patterns.match_('{(...)}', t.q || '')
                if (
          ...
          'pu-2': {
            ...
            actions: {
              ...
              output: function (t) {
                var e = []
                if (t.rm) {
                  var n = a.patterns.match_('{(...)}', t.rm || '')
                  e = n && '' === n.remainder ? a.go(n.match_, 'pu') : { type_: 'rm', p1: t.rm }
                }
            ...
            actions: {
              ...
              'output-0': function (t) {
                ...
                if (((t.text_ = t.text_ || ''), t.text_.length > 4)) {
                  ...
                  0 === n && (n = 3)
                  for (var o = t.text_.length - 3; o > 0; o -= 3)
                    (e.push(t.text_.substr(o, 3)), e.push({ type_: '1000 separator' }))
              ...
              'output-o': function (t) {
                var e = []
                if (((t.text_ = t.text_ || ''), t.text_.length > 4)) {
                  for (var n = t.text_.length - 3, o = 0; o < n; o += 3)
                    (e.push(t.text_.substr(o, 3)), e.push({ type_: '1000 separator' }))
                  e.push(t.text_.substr(o))
                } else e.push(t.text_)
                for (var a in t) delete t[a]
                return e
              },
        ...
        var r = {
          go: function (t, e) {
            if (!t) return ''
            for (var n = '', o = !1, a = 0; a < t.length; a++) {
              var i = t[a]
              'string' == typeof i
                ? (n += i)
                : ((n += r._go2(i)), '1st-level escape' === i.type_ && (o = !0))
            }
            return (e || o || !n || (n = '{' + n + '}'), n)
          },
          _goInner: function (t) {
          ...
          _go2: function (t) {
            ...
            switch (t.type_) {
              case 'chemfive':
                ...
                ;(n.a && (n.a.match(/^[+\-]/) && (n.a = '{' + n.a + '}'), (e += n.a + '\\,')),
                  (n.b || n.p) &&
                    ((e += '{\\vphantom{X}}'),
                    (e += '^{\\hphantom{' + (n.b || '') + '}}_{\\hphantom{' + (n.p || '') + '}}'),
                    (e += '{\\vphantom{X}}'),
                    (e += '^{\\smash[t]{\\vphantom{2}}\\mathllap{' + (n.b || '') + '}}'),
                    (e += '_{\\vphantom{2}\\mathllap{\\smash[t]{' + (n.p || '') + '}}}')),
                  n.o && (n.o.match(/^[+\-]/) && (n.o = '{' + n.o + '}'), (e += n.o)),
                  'kv' === t.dType
                    ? ((n.d || n.q) && (e += '{\\vphantom{X}}'),
                      n.d && (e += '^{' + n.d + '}'),
                      n.q && (e += '_{\\smash[t]{' + n.q + '}}'))
                    : 'oxidation' === t.dType
                      ? (n.d && ((e += '{\\vphantom{X}}'), (e += '^{' + n.d + '}')),
                        n.q && ((e += '{\\vphantom{X}}'), (e += '_{\\smash[t]{' + n.q + '}}')))
                      : (n.q && ((e += '{\\vphantom{X}}'), (e += '_{\\smash[t]{' + n.q + '}}')),
                        n.d && ((e += '{\\vphantom{X}}'), (e += '^{' + n.d + '}'))))
                break
              case 'rm':
              ...
              case 'bond':
                ...
                break
              case 'frac':
                var o = '\\frac{' + t.p1 + '}{' + t.p2 + '}'
                e = '\\mathchoice{\\textstyle' + o + '}{' + o + '}{' + o + '}{' + o + '}'
                break
              case 'pu-frac':
                var a = '\\frac{' + r._goInner(t.p1) + '}{' + r._goInner(t.p2) + '}'
              ...
              case '1st-level escape':
                ...
                break
              case 'frac-ce':
                e = '\\frac{' + r._goInner(t.p1) + '}{' + r._goInner(t.p2) + '}'
                break
              case 'overset':
                e = '\\overset{' + r._goInner(t.p1) + '}{' + r._goInner(t.p2) + '}'
                break
              case 'underset':
                e = '\\underset{' + r._goInner(t.p1) + '}{' + r._goInner(t.p2) + '}'
                break
              case 'underbrace':
                e = '\\underbrace{' + r._goInner(t.p1) + '}_{' + r._goInner(t.p2) + '}'
                break
              case 'color':
