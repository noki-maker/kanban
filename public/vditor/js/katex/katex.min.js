  ...
  return (function () {
    ...
    for (var qe = '', Ie = 0; Ie < Be.length; Ie++) {
      ...
      ;(ie(oe, le, de, Re, (qe = String.fromCharCode(55349, 56320 + Ie))),
        ...
        ie(se, le, xe, Re, qe),
        ie(oe, le, de, Re, (qe = String.fromCharCode(55349, 56684 + Ie))),
        ie(se, le, xe, Re, qe),
    ...
    var Ve = [
      ...
      Fe = function (e, t, r) {
        return (
          ae[r][e] && ae[r][e].replace && (e = ae[r][e].replace), { value: e, metrics: N(e, t, r) }
        )
      },
      ...
      Ke = {
        ...
        makeOrd: function (e, t, r) {
          ...
          if (h.length > 0) return Ge(i, h, a, t, o.concat(c))
          if (l) {
            var u, p
            if ('boldsymbol' === l) {
    ...
    var lr = function (e, t, r) {
      ...
      pr = function (e, t, r) {
        ...
        return (
          (o.height = t), (o.style.height = F(t)), (o.style.width = F(n)), { type: 'elem', elem: o }
        )
      },
    ...
    ;(ot({
      ...
      ot({
        ...
        handler: function (e, t) {
          ...
          return { type: 'leftright-right', mode: e.parser.mode, delim: Rr(t[0], e).text, color: r }
        },
      }),
      ot({
        type: 'leftright',
              ...
              for (var a, i, o = [], s = [o], l = 0; l < t.length; l++) {
                for (
                  ...
                  if (tr(h[m])) {
                    ...
                    var v = { type: 'styling', body: [rr(u, p, e)], mode: 'math', style: 'display' }
                    ;(o.push(v),
                      (c = { type: 'styling', body: [], mode: 'math', style: 'display' }))
