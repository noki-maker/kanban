          ...
          (n = function (t) {
            ...
            var it = function (t) {
                  ...
                  it = ht(function (t) {
                    try {
                      ...
                      return (
                        ...
                        (
                          '000000' +
                          (e = ((255 & e) << 16) | (65280 & e) | ((16711680 & e) >>> 16)).toString(
                            16,
                          )
                        ).slice(-6)
                      )
              ...
              ot = function (t, r, i) {
                ...
                return (
                  (t > 1 || r > 1 || i > 1) && ((t /= 255), (r /= 255), (i /= 255)), [t, r, i]
                )
              },
              lt = function (t, r, i, n) {
                var a = {
                  ...
                  h[5]
                    ...
                    : h[6]
                      ...
                      : (((h = { r: r, g: i, b: n, toString: ut }).hex =
                          '#' + (16777216 | n | (i << 8) | (r << 16)).toString(16).slice(1)),
                  ...
                  n.length ||
                    x(t).replace(V, function (t, e, r) {
                      ...
                      if (
                        ...
                        'm' == s &&
                          a.length > 2 &&
                          (n.push([e][f](a.splice(0, 2))), (s = 'l'), (e = 'm' == e ? 'l' : 'L')),
                        'r' == s)
                      )
                        n.push([e][f](a))
                ...
                for (var x = 0; x < h; x++) {
                  ...
                  if (S) {
                    ...
                    T >= 0 &&
                      ...
                      A >= 0 &&
                      A <= 1.001 &&
                      (i ? p++ : p.push({ x: S.x, y: S.y, t1: k(T, 1), t2: k(A, 1) }))
                  }
                }
              return p
            }
            ...
            var yt = (e.pathBBox = function (t) {
              ...
              _t = (e._pathToAbsolute = function (t) {
                ...
                var i = [],
                  ...
                  l = 0
                'M' == t[0][0] &&
                  ((s = n = +t[0][1]), (o = a = +t[0][2]), l++, (i[0] = ['M', n, a]))
                for (
                  var h,
                    u,
                    c =
                          ...
                          : 's' == w
                            ? 2 == _ || 3 == _
                              ...
                              : 5 == _ &&
                                ...
                                (o *= b[1]),
                                (l *= b[2]))
                            : 'm' == w && 7 == _ && u.add(b[1], b[2], b[3], b[4], b[5], b[6]),
                        (h.dirtyT = 1),
                        (t.matrix = u))
                    }
                  ;((t.matrix = u),
                    ...
                    return e.isSimple
                      ? ((e.scalex = +e.scalex.toFixed(4)),
                        ...
                        (e.dx || e.dy ? 't' + [e.dx, e.dy] : d) +
                          (1 != e.scalex || 1 != e.scaley ? 's' + [e.scalex, e.scaley, 0, 0] : d) +
                      ...
                      if (p + (h = Xt(s, o, l[1], l[2], l[3], l[4], l[5], l[6])) > n) {
                        if (r && !f.start) {
                          if (
                            ((c += [
                              'C' +
                                (u = Xt(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p)).start.x,
                              u.start.y,
                              u.m.x,
                              u.m.y,
                              u.x,
            ...
            var Jt = (e.easing_formulas = {
              ...
              '<>': function (t) {
                var e = 0.48 - t / 1.04,
                  ...
                  i = r - e,
                  n = -r - e,
                  a = C(B(i), 1 / 3) * (i < 0 ? -1 : 1) + C(B(n), 1 / 3) * (n < 0 ? -1 : 1) + 0.5
                ...
                if (c) ((c.initstatus = s), (c.start = new Date() - c.ms * s))
                  ...
                  for (var S in u)
                    if (u[o](S) && (I[o](S) || i.paper.customAttributes[o](S)))
                      switch (
                        ((b[S] = i.attr(S)), null == b[S] && (b[S] = j[S]), (_[S] = u[S]), I[S])
                      ) {
                        case T:
                          w[S] = (_[S] - b[S]) / m
                          break
                  ...
                  if (
                    ...
                    s &&
                      !c &&
                      !p &&
                      ((k.stop = !0), (k.start = new Date() - m * s), 1 == Kt.length))
                  )
                    return ee()
                ...
                if ((e.is(a, 'string') && (a = this.getFont(a)), a)) {
                  ...
                  for (
                    var y = a.face.bbox[v](n),
                      ...
                      b = y[3] - y[1],
                      _ = 0,
                      B = +y[1] + ('baseline' == o ? b + +a.face.descent : b / 2),
                      C = 0,
                      S = c.length;
                    C < S;
                    C++
                    ...
                    return (function (t, e, r) {
                      ...
                      return (
                        e.replace(le, function (t, e, r, n, a) {
                          ;((e = e || n),
                            i && (e in i && (i = i[e]), 'function' == typeof i && a && (i = i())))
                        }),
                        (i = (null == i || i == r ? t : i) + '')
                      )
                    })(t, r, e)
            ...
            if (!t || t.svg) {
              ...
              var x = function (i, n) {
                ...
                v = function (e, n) {
                  ...
                  if (!m) {
                    if (
                      ((n = (n = r(n).replace(t._radial_gradient, function (t, e, r) {
                        if (((h = 'radial'), e && r)) {
                          f = i(e)
                          var n = 2 * ((p = i(r)) > 0.5) - 1
                ...
                y = function (t) {
                  ...
                  var e,
                    r = document.location
                  return (
                    "url('" + (r.protocol + '//' + r.host + r.pathname + r.search) + '#' + t + "')"
                  )
                },
                m = function (t) {
                  var e = t.getBBox(1)
                    ...
                    if (a[e](d)) {
                      ...
                      switch (((u[d] = g), d)) {
                        ...
                        case 'clip-rect':
                          ...
                          if (4 == S.length) {
                            ...
                            var T = x('clipPath'),
                              A = x('rect')
                            ;((T.id = t.createUUID()),
                              x(A, { x: S[0], y: S[1], width: S[2], height: S[3] }),
                              T.appendChild(A),
                        ...
                        case 'cy':
                          ...
                          break
                        case 'r':
                          ;('rect' == i.type ? x(l, { rx: g, ry: g }) : l.setAttribute(d, g),
                            (i._.dirty = 1))
                          break
                        case 'src':
                        ...
                        case 'fill':
                          ...
                          if (P.error) {
                            if (
                              ('circle' == i.type || 'ellipse' == i.type || 'r' != r(g).charAt()) &&
                              v(i, g)
                            ) {
              ...
              ;((S.prototype = T),
                ...
                (T.attr = function (r, i) {
                  ...
                  if (null == r) {
                    ...
                    return (
                      n.gradient && 'none' == n.fill && (n.fill = n.gradient) && delete n.gradient,
                ...
                (t._engine.circle = function (t, e, r, i) {
                  ...
                  var a = new S(n, t)
                  return (
                    (a.attrs = { cx: e, cy: r, r: i, fill: 'none', stroke: '#000' }),
                    (a.type = 'circle'),
                    x(n, a.attrs),
                    a
                  )
                ...
                (t._engine.ellipse = function (t, e, r, i, n) {
                  ...
                  var s = new S(a, t)
                  return (
                    (s.attrs = { cx: e, cy: r, rx: i, ry: n, fill: 'none', stroke: '#000' }),
                    (s.type = 'ellipse'),
                    x(a, s.attrs),
                    s
                  )
                ...
                (t._engine.image = function (t, e, r, i, n, a) {
                  var s = x('image')
                  ;(x(s, { x: r, y: i, width: n, height: a, preserveAspectRatio: 'none' }),
                    s.setAttributeNS(p, 'href', e),
                    t.canvas && t.canvas.appendChild(s))
                  var o = new S(s, t)
                  return (
                    (o.attrs = { x: r, y: i, width: n, height: a, src: e }), (o.type = 'image'), o
                  )
                }),
            ...
            if (!t || t.vml) {
                      ...
                      if (I) {
                        ...
                        ((j.color = t.getRGB(l.fill).hex),
                          ...
                          t.getRGB(l.fill).error &&
                            (T.type in { circle: 1, ellipse: 1 } || 'r' != r(l.fill).charAt()) &&
                            S(T, l.fill, j) &&
              ...
              ;((T.prototype = A),
                ...
                (A.transform = function (e) {
                  ...
                  return (
                    null !== i && ((this._.transform = i), t._extractTransform(this, i)), this
                  )
                }),
...
!(function (t, i) {
  ...
  return (function (t) {
    ...
    function (t, i, e) {
      ...
      e(15)
      var n = { parse: s }
      ;('undefined' != typeof window && (window.flowchart = n), (t.exports = n))
    },
    function (t, i) {
      function e(t, i) {
        ...
        for (n in t) t[n] && ('object' == typeof s[n] ? (s[n] = e(s[n], t[n])) : (s[n] = t[n]))
        return s
      }
      function s(t, i) {
      ...
      t.exports = { defaults: e, inherits: s }
    },
    function (t, i, e) {
      function s(t, i, e) {
        ;((this.chart = t),
        ...
        ;(s && this.text.attr({ font: s }),
          n && this.text.attr({ 'font-family': n }),
          h && this.text.attr({ 'font-weight': h }),
      ...
      ;((s.prototype.getAttr = function (t) {
        if (this.chart) {
          var i,
            ...
            s = this.chart.options.symbols ? this.chart.options.symbols[this.symbolType][t] : void 0
          return (
          ...
          if (this.next) {
            ...
            if ('right' === this.next_direction) {
              ...
              this.next.isPositioned ||
                (this.next.setY(e.y - this.next.height / 2),
                ...
                (function e() {
                  ...
                  if (n) {
                    ...
                    ;(t.next.setX(s.getX() + s.width + i), e())
                  }
                })(),
              ...
              var s = this.getLeft()
              this.next.isPositioned ||
                (this.next.setY(s.y - this.next.height / 2),
                this.next.shiftX(-(this.group.getBBox().x + this.width + i)),
                (function e() {
                  for (var s, n = !1, h = 0, o = t.chart.symbols.length; h < o; h++) {
                    s = t.chart.symbols[h]
              ...
              this.next.isPositioned ||
                (this.next.shiftY(this.getY() + this.height + i),
          ...
          if ((e && 'bottom' !== e) || !u || !_)
            if ((e && 'right' !== e) || !b || !L)
              if ((e && 'left' !== e) || !b || !w)
                        ...
                        if ((e && 'bottom' !== e) || !L)
                            ...
                            'left' === e
                              ? ((n = 10 * Math.max(t.topLines.length, this.leftLines.length)),
                                (s = h(
                                  ...
                                  x,
                                  [
                                    { x: c.x + (x.x - c.x) / 2, y: x.y },
                                    { x: c.x + (x.x - c.x) / 2, y: c.y - B / 2 - n },
                                    { x: c.x, y: c.y - B / 2 - n },
                                    { x: c.x, y: c.y },
                                  ],
                                  i,
                                ...
                                (k = x.x))
                              : 'top' === e &&
                                ((n = 10 * Math.max(t.topLines.length, this.topLines.length)),
                                (s = h(
                                  this.chart,
                                  y,
                                  [
                          ...
                          ((n = 10 * Math.max(t.topLines.length, this.bottomLines.length)),
                            (s = h(
                              ...
                              [
                                { x: p.x, y: p.y + B / 2 - n },
                                { x: p.x + (p.x - c.x) / 2, y: p.y + B / 2 - n },
                                { x: p.x + (p.x - c.x) / 2, y: c.y - B / 2 - n },
                                { x: c.x, y: c.y - B / 2 - n },
                                { x: c.x, y: c.y },
                              ],
                              i,
                ...
                (0 === t.rightLines.length && 0 === this.leftLines.length
                  ? (s = h(this.chart, x, d, i))
                  : ((n = 10 * Math.max(t.rightLines.length, this.leftLines.length)),
                    (s = h(
                      this.chart,
                      l,
                      [
              ...
              (0 === t.leftLines.length && 0 === this.rightLines.length
                ? (s = h(this.chart, l, m, i))
                : ((n = 10 * Math.max(t.leftLines.length, this.rightLines.length)),
                  (s = h(
                    this.chart,
                    l,
                    [
            ...
            (0 === t.topLines.length && 0 === this.bottomLines.length
              ? (s = h(this.chart, p, c, i))
              : ((n = 10 * Math.max(t.topLines.length, this.bottomLines.length)),
                (s = h(
                  this.chart,
                  p,
              ...
              (t.topEnd = !0),
              (k = p.x))
          if ((this.lineStyle[t.key] && s && s.attr(this.lineStyle[t.key]), s)) {
            for (var O = 0, X = this.chart.lines.length; O < X; O++)
              for (
                var T = this.chart.lines[O],
                  S = T.attr('path'),
                  C = s.attr('path'),
                  Y = 0,
                  P = S.length - 1;
                ...
                var j = []
                ;(j.push(['M', S[Y][1], S[Y][2]]), j.push(['L', S[Y + 1][1], S[Y + 1][2]]))
                for (
                  var E = j[0][1], z = j[0][2], F = j[1][1], R = j[1][2], $ = 0, N = C.length - 1;
                  $ < N;
                  $++
                ) {
                  var V = []
                  ;(V.push(['M', C[$][1], C[$][2]]), V.push(['L', C[$ + 1][1], C[$ + 1][2]]))
                  var G = V[0][1],
                    I = V[0][2],
                    W = V[1][1],
                    Q = V[1][2],
            ...
            ;(this.chart.lines.push(s),
              (void 0 === this.chart.minXFromSymbols || this.chart.minXFromSymbols > x.x) &&
                (this.chart.minXFromSymbols = x.x))
          }
          ;(!this.chart.maxXFromLine || (this.chart.maxXFromLine && k > this.chart.maxXFromLine)) &&
    ...
    function (t, i) {
      function e(t, i, e) {
        var s,
          n,
          h = 'M{0},{1}'
        for (s = 2, n = 2 * e.length + 2; s < n; s += 2) h += ' L{' + s + '},{' + (s + 1) + '}'
        var o = [i.x, i.y]
        for (s = 0, n = e.length; s < n; s++) (o.push(e[s].x), o.push(e[s].y))
        ...
        return (
          a && r.attr({ font: a }),
          l && r.attr({ 'font-family': l }),
          p && r.attr({ 'font-weight': p }),
          r
        )
      }
      function s(t, i, e, s) {
        ...
        var o = 'M{0},{1}'
        for (n = 2, h = 2 * e.length + 2; n < h; n += 2) o += ' L{' + n + '},{' + (n + 1) + '}'
        var r = [i.x, i.y]
        for (n = 0, h = e.length; n < h; n++) (r.push(e[n].x), r.push(e[n].y))
        ...
        if (
          ...
          var m = 0,
            u = 0
          ;(x
            ? ((m = i.x > d.x ? i.x - (i.x - d.x) / 2 : d.x - (d.x - i.x) / 2),
              (u = i.y > d.y ? i.y - (i.y - d.y) / 2 : d.y - (d.y - i.y) / 2),
              c
                ? ((m -= g.getBBox().width / 2), (u -= t.options['text-margin']))
                : ((m += t.options['text-margin']), (u -= g.getBBox().height / 2)))
            : ((m = i.x),
              (u = i.y),
              c
                ? (i.x > d.x
                    ? ((m -= t.options['text-margin'] / 2), (f = 'end'))
                    : (m += t.options['text-margin'] / 2),
            ...
            l && g.attr({ font: l }),
            p && g.attr({ 'font-family': p }),
            y && g.attr({ 'font-weight': y }))
        }
        return a
      }
      function n(t, i, e, s, n, h, o, r) {
        var a,
          ...
          y,
          x,
          g = { x: null, y: null, onLine1: !1, onLine2: !1 }
        return (
          (a = (r - h) * (e - t) - (o - n) * (s - i)),
          0 === a
            ? g
      ...
      t.exports = { drawPath: e, drawLine: s, checkLineIntersection: n }
    },
    function (t, i, e) {
      function s(t) {
        function i(t) {
        ...
        function g(t) {
          ...
          var n = s.split('@')
          if (n.length > 1) return i >= 0 && e >= 0 ? n[1] : ''
        }
        ;((t = t || ''), (t = t.trim()))
        for (
          var f = {
                  ...
                  return (
                    ...
                    o.pathOk
                      ...
                      : (o instanceof p
                          ...
                          : o instanceof y
                            ? (i.path1 && t(i.path1, o, i),
                              i.path2 && t(i.path2, o, i),
                              i.path3 && t(i.path3, o, i))
                            : i.next && t(i.next, o, i),
                        o)
                  )
                })(this.start),
          ...
          if ('\n' === t[m] && '\\' !== t[m - 1]) {
            ...
            ;((d = m + 1), c.push(b.replace(/\\\n/g, '\n')))
          }
        d < t.length && c.push(t.substr(d))
        for (var _ = 1, v = c.length; _ < v;) {
          var w = c[_]
          w.indexOf('->') < 0 && w.indexOf('=>') < 0 && w.indexOf('@>') < 0
            ? ((c[_ - 1] += '\n' + w), c.splice(_, 1), v--)
            : _++
        }
        for (; c.length > 0;) {
          ...
          if (L.indexOf('=>') >= 0) {
            ...
            var T
            if (
              (B.symbolType.indexOf(': ') >= 0 &&
                ((T = B.symbolType.split(': ')),
                (B.symbolType = T.shift()),
                (B.text = T.join(': '))),
              B.text && B.text.indexOf(':$') >= 0
                ? ((T = B.text.split(':$')), (B.text = T.shift()), (B.function = T.join(':$')))
                : B.symbolType.indexOf(':$') >= 0
                  ? ((T = B.symbolType.split(':$')),
                    (B.symbolType = T.shift()),
                    (B.function = T.join(':$')))
                  : B.text && B.text.indexOf(':>') >= 0
                    ? ((T = B.text.split(':>')), (B.text = T.shift()), (B.link = T.join(':>')))
                    : B.symbolType.indexOf(':>') >= 0 &&
                      ((T = B.symbolType.split(':>')),
                      (B.symbolType = T.shift()),
                      (B.link = T.join(':>'))),
              ...
              S >= 0 &&
                C >= 0 &&
                ((B.target = B.link.substring(S, C)), (B.link = B.link.substring(0, S - 1)))
            }
            if (B.text && B.text.indexOf('|') >= 0) {
              var Y = B.text.split('|')
              ;((B.flowstate = Y.pop().trim()), (B.text = Y.join('|')))
            }
            f.symbols[B.key] = B
          } else if (L.indexOf('->') >= 0) {
            var P = g(L)
            ...
            for (var j = L.split('->'), E = 0, z = j.length; E < z; E++) {
              var F = j[E],
                R = e(F)
              ;('true' !== R && 'false' !== R) ||
                ((F = F.replace('true', 'yes')), (F = F.replace('false', 'no')))
              var $ = x(F),
                N = s(F),
                V = null
              if ($.indexOf(',') >= 0) {
              ...
              if (
                (P &&
                  ('yes' == $ || 'true' == $ ? (N.yes_annotation = P) : (N.no_annotation = P),
                  (P = null)),
                f.start || (f.start = N),
                E + 1 < z)
              ) {
                var I = j[E + 1]
                ;((N[$] = s(I)), (N['direction_' + $] = V), (V = null))
              }
            }
          } else if (L.indexOf('@>') >= 0)
      ...
      function s(t, i) {
        ;((i = i || {}),
          ...
          this.no_direction || 'right' !== this.yes_direction
            ? this.yes_direction || 'bottom' !== this.no_direction || (this.yes_direction = 'right')
        ...
        ;(p.attr({
          ...
          this.text.attr({ y: p.getBBox().height / 2 }),
          this.group.push(p),
              ...
              ;(!(function i() {
                for (var e, n = !1, h = 0, o = s.chart.symbols.length; h < o; h++)
                  if (
                    ...
                    if (
                      e.getCenter().y > s.right_symbol.getCenter().y &&
                      r <= s.right_symbol.width / 2
                    ) {
                      n = !0
                      break
                    }
                ...
                if (n) {
                  if ('end' === s.right_symbol.symbolType) return
                  ;(s.right_symbol.setX(e.getX() + e.width + t), i())
                }
              })(),
              ...
              ;(!(function i() {
                for (var e, n = !1, h = 0, o = s.chart.symbols.length; h < o; h++)
                  if (
                    ...
                    if (
                      e.getCenter().y > s.left_symbol.getCenter().y &&
                      r <= s.left_symbol.width / 2
                    ) {
                      n = !0
                      break
                    }
                ...
                if (n) {
                  if ('end' === s.left_symbol.symbolType) return
                  ;(s.left_symbol.setX(e.getX() + e.width + t), i())
                }
              })(),
    ...
    function (t, i, e) {
      function s(t, i) {
        ...
        ;((i = i || {}),
          ...
          (this.params = i.params),
          'path1' === i.direction_next &&
            !i[i.direction_next] &&
            i.next &&
            (i[i.direction_next] = i.next),
          'path2' === i.direction_next &&
            !i[i.direction_next] &&
            i.next &&
            (i[i.direction_next] = i.next),
          'path3' === i.direction_next &&
            !i[i.direction_next] &&
            i.next &&
            (i[i.direction_next] = i.next),
          i.path1 &&
          ...
          !i.direction_path3
            ...
            : i.path1 &&
                ...
                i.path3 &&
                !i.direction_path3
              ? 'right' === i.direction_path2
                ? ((this.path1_direction = 'bottom'),
                  (this.path2_direction = 'right'),
                  (this.path3_direction = 'top'))
                : 'left' === i.direction_path2
                  ? ((this.path1_direction = 'bottom'),
                ...
                ? 'right' === i.direction_path2
                  ...
                  : 'left' === i.direction_path2
                    ...
                    : ((this.path1_direction = 'right'),
                      (this.path2_direction = 'bottom'),
                      (this.path3_direction = 'top'))
                : ((this.path1_direction = i.direction_path1),
        ...
        (s.prototype.render = function () {
          ...
          if (this.top_symbol) {
            ...
            this.top_symbol.isPositioned ||
              (this.top_symbol.shiftY(this.getY() - this.top_symbol.height - t),
          ...
          if (this.right_symbol) {
            ...
            this.right_symbol.isPositioned ||
              (this.right_symbol.setY(h.y - this.right_symbol.height / 2),
              this.right_symbol.shiftX(this.group.getBBox().x + this.width + t),
              (function i() {
                for (var e, n = !1, h = 0, o = s.chart.symbols.length; h < o; h++)
                  if (
      ...
      ;((s.prototype.handle = function (t) {
        ...
        (s.prototype.render = function () {
          var t,
            ...
            a = 0,
            l = 0
          for (n = 0, h = this.symbols.length; n < h; n++)
            ((t = this.symbols[n]), t.width > e && (e = t.width), t.height > s && (s = t.height))
          for (n = 0, h = this.symbols.length; n < h; n++)
            ((t = this.symbols[n]),
              t.shiftX(this.options.x + (e - t.width) / 2 + this.options['line-width']),
              t.shiftY(this.options.y + (s - t.height) / 2 + this.options['line-width']))
          for (this.start.render(), n = 0, h = this.symbols.length; n < h; n++)
            ((t = this.symbols[n]), t.renderLines())
          o = this.maxXFromLine
          var p, y
          for (n = 0, h = this.symbols.length; n < h; n++) {
            t = this.symbols[n]
          ...
          for (n = 0, h = this.lines.length; n < h; n++) {
            ;((i = this.lines[n].getBBox()), (p = i.x), (y = i.y))
            var g = i.x2,
              f = i.y2
            ;(p < a && (a = p), y < l && (l = y), g > o && (o = g), f > r && (r = f))
          }
          ...
          var m = o + d - a,
            u = r + d - l
          ;(this.paper.setSize(m * c, u * c), this.paper.setViewBox(a, l, m, u, !0))
        }),
    ...
    function (t, i, e) {
      function s(t, i) {
        ...
        ;((i = i || {}), (i.text = i.text || 'End'), n.call(this, t, i, e))
      }
      var n = e(2),
        h = e(1).inherits
      ;(h(s, n), (t.exports = s))
    ...
    function (t, i, e) {
      function s(t, i) {
        ...
        var e = this.text.getBBox().width + 4 * this.textMargin,
          ...
          a = { x: h, y: o },
          l = [
            { x: h - this.textMargin, y: s },
            { x: h - this.textMargin + e, y: s },
            { x: h - this.textMargin + e + 2 * this.textMargin, y: 0 },
            { x: h - this.textMargin + 2 * this.textMargin, y: 0 },
            { x: h, y: o },
          ],
          p = r(t, a, l)
        ;(p.attr({
    ...
    function (t, i, e) {
      function s(t, i) {
        var e = t.paper.rect(0, 0, 0, 0, 20)
        ;((i = i || {}), (i.text = i.text || 'Start'), n.call(this, t, i, e))
      }
      var n = e(2),
        h = e(1).inherits
      ;(h(s, n), (t.exports = s))
    ...
    function (t, i, e) {
      function s(t, i) {
        ...
        ;((i = i || {}),
          n.call(this, t, i, e),
          e.attr({ width: this.text.getBBox().width + 4 * this.getAttr('text-margin') }),
        ...
        ;(h && s.attr({ font: h }),
          o && s.attr({ 'font-family': o }),
          r && s.attr({ 'font-weight': r }),
        ...
        !(function (t) {
          ...
          var e = {
            init: function (i) {
              return this.each(function () {
                var e = t(this)
                ;((this.chart = s(e.text())), e.html(''), this.chart.drawSVG(this, i))
              })
            },
                    ...
                    if (i(a, e)) {
                      ...
                      for (var l = 0; l < h.length; l++) {
                        ...
                        r[p] &&
                          ...
                          r[p].params[t] &&
                          i(r[p].params[t], e) &&
                          (r.lineStyle[r[p].key] = { stroke: n.options().flowstate[s].fill })
                      }
                    }
                  }
                ;(n.clean(), n.drawSVG(this))
              })
            },
          ...
          t.fn.flowChart = function (i) {
            return e[i]
              ...
              : 'object' != typeof i && i
                ? void t.error('Method ' + i + ' does not exist on jQuery.flowChart')
