!(function (t) {
      ...
      c = (function () {
        function t(t, e, r) {
          ...
          if ((delete e.isInner, e)) {
            a = {}
            try {
              for (var c = n(Object.keys(e)), p = c.next(); !p.done; p = c.next()) {
                var f = p.value
                a[f] = e[f]
              }
            } catch (t) {
        ...
        return (
          ...
          (t.prototype.toString = function () {
            ...
            try {
              for (
                var i = n(Array.from(this.configuration.handlers.keys())), o = i.next();
                !o.done;
                o = i.next()
              ) {
                var a = o.value
          ...
          (t.prototype.GetDimen = function (t) {
            if ('{' === this.GetNext()) {
              var e = this.GetArgument(t),
                r = i(a.default.matchDimen(e), 2),
                n = r[0],
                o = r[1]
              if (n) return n + o
            } else {
              e = this.string.slice(this.i)
              var s = i(a.default.matchDimen(e, !0), 3),
                u = ((n = s[0]), (o = s[1]), s[2])
  ...
  function (t, e, r) {
    ...
    ;(r(25),
      (function (t) {
        ...
        function h(t, r) {
          ...
          return i
            ? (function (t) {
                ...
                return [d(e[o](parseFloat(i || '1'))).slice(0, -2), 'em', a]
        ...
        function b(t, e) {
          for (var r = t.length, n = 0, i = '', o = 0, a = 0, s = !0, l = !1; o < r;) {
            var c = t[o++]
            switch (c) {
              case ' ':
                break
              ...
              case '}':
                ...
                break
              default:
                if (!n && -1 !== e.indexOf(c)) return [l ? 'true' : v(i, a), c, t.slice(o)]
                ;((s = !1), (l = !1))
            }
            i += c
          }
        ...
        ;((t.matchDimen = h),
          ...
          (t.Em = d),
          (t.fenced = function (t, e, r, n, i) {
            void 0 === i && (i = '')
            var o,
              u = t.nodeFactory,
              c = u.create('node', 'mrow', [], { open: e, close: n, texClass: a.TEXCLASS.INNER })
            if (i) o = new l.default('\\' + i + 'l' + e, t.parser.stack.env, t).mml()
            else {
              var p = u.create('text', e)
              o = u.create(
                'node',
                'mo',
                [],
                { fence: !0, stretchy: !0, symmetric: !0, texClass: a.TEXCLASS.OPEN },
                p,
              )
            }
            if (
              (s.default.appendChildren(c, [o]),
              ...
              o = new l.default('\\' + i + 'r' + n, t.parser.stack.env, t).mml()
            else {
              ...
              o = u.create(
                ...
                'mo',
                [],
                { fence: !0, stretchy: !0, symmetric: !0, texClass: a.TEXCLASS.CLOSE },
                f,
              )
            }
            return (s.default.appendChildren(c, [o]), c)
          }),
          ...
          (t.fixInitialMO = function (t, e) {
            for (var r = 0, n = e.length; r < n; r++) {
              ...
              if (
                ...
                (!s.default.isType(i, 'TeXAtom') ||
                  (s.default.getChildren(i)[0] &&
                    s.default.getChildren(s.default.getChildren(i)[0]).length))
              ) {
                if (
                  s.default.isEmbellished(i) ||
                  (s.default.isType(i, 'TeXAtom') && s.default.getTexClass(i) === a.TEXCLASS.REL)
                ) {
          ...
          (t.internalMath = function (t, e, r, n) {
                ...
                if ('$' === (i = e.charAt(p++)))
                  '$' === h && 0 === d
                    ? ((o = t.create('node', 'TeXAtom', [
                      ...
                      (f = p))
                    : '' === h &&
                      (f < p - 1 && c.push(g(t, e.slice(f, p - 1), s)), (h = '$'), (f = p))
                else if ('{' === i && '' !== h) d++
                else if ('}' === i)
                  if ('}' === h && 0 === d) {
                    var m = new l.default(e.slice(f, p), {}, t.configuration).mml()
                    ;((o = t.create('node', 'TeXAtom', [m], s)), c.push(o), (h = ''), (f = p))
                  } else '' !== h && d && d--
                else if ('\\' === i)
                  if ('' === h && e.substr(p).match(/^(eq)?ref\s*\{/)) {
                    var y = RegExp['$&'].length
                    ;(f < p - 1 && c.push(g(t, e.slice(f, p - 1), s)),
                      (h = '}'),
                      (f = p - 1),
                      (p += y))
                  } else
                    '(' === (i = e.charAt(p++)) && '' === h
                      ? (f < p - 2 && c.push(g(t, e.slice(f, p - 2), s)), (h = ')'), (f = p))
                      : ')' === i && ')' === h && 0 === d
                        ? ((o = t.create('node', 'TeXAtom', [
            ...
            return (
              f < e.length && c.push(g(t, e.slice(f), s)),
              null != r
            ...
            for (var n = '', i = '', o = 0; o < r.length;) {
              ...
              if ('\\' === a) n += a + r.charAt(o++)
                ...
                if ('#' === (a = r.charAt(o++))) n += a
                  ...
                  ;((i = y(t, y(t, i, n), e[parseInt(a, 10) - 1])), (n = ''))
                }
              else n += a
            }
            return y(t, i, n)
              ...
              try {
                for (var l = i(Object.keys(s)), c = l.next(); !c.done; c = l.next()) {
                  ...
                  if (!e.hasOwnProperty(p)) {
                    if (r) throw new u.default('InvalidOption', 'Invalid optional argument: %1', p)
                    delete s[p]
                  }
                }
              } catch (t) {
  ...
  function (t, e, r) {
    ...
    e.Label = s
    var l = function (t, e, r, n, i, o, a, s) {
      ;(void 0 === t && (t = ''),
        void 0 === e && (e = !1),
        void 0 === r && (r = !1),
        void 0 === n && (n = null),
      ...
      (function (t) {
        ...
        ;((t.OPTIONS = {
          ...
          (t.addTags = function (e) {
            var r, n
            try {
              for (var i = o(Object.keys(e)), a = i.next(); !a.done; a = i.next()) {
                var s = a.value
                t.add(s, e[s])
              }
            } catch (t) {
  ...
  function (t, e, r) {
    ...
    var l = (function () {
      function t() {
        ;((this._configuration = new a.PrioritizedList()), (this._fallback = new s.FunctionList()))
      }
      return (
        (t.prototype.add = function (t, e, r) {
          ...
          try {
            for (var l = n(t.slice().reverse()), u = l.next(); !u.done; u = l.next()) {
              var c = u.value,
                p = o.getMap(c)
              if (!p) return void this.warn('Configuration ' + c + ' not found! Omitted.')
        ...
        (t.prototype.add = function (t, e, r) {
          ...
          try {
            for (var s = n(Object.keys(t)), u = s.next(); !u.done; u = s.next()) {
              var c = u.value,
                p = this.get(c)
              ;(p || ((p = new l()), this.set(c, p)), p.add(t[c], e[c], r))
            }
          } catch (t) {
            i = { error: t }
          } finally {
  ...
  function (t, e, r) {
    ...
    var l = r(1),
      u = (function () {
        ...
        return (
          ...
          (t.prototype.create = function (t) {
            for (var e, r = [], n = 1; n < arguments.length; n++) r[n - 1] = arguments[n]
            return (e = this.factory.configuration.nodeFactory).create.apply(e, a([t], r))
          }),
          t
        )
      })()
    ...
    var c = (function (t) {
      function e(e) {
        ...
        return (
          (i.factory = e), (i.global = {}), (i._properties = {}), i.isOpen && (i._env = {}), i
        )
      }
      return (
        i(e, t),
        ...
        (e.prototype.checkItem = function (t) {
          ...
          if (t.isClose && this.getErrors(t.kind)) {
            var r = o(this.getErrors(t.kind), 2),
              n = r[0],
              i = r[1]
            throw new l.default(n, i, t.getName())
          }
  ...
  function (t, e, r) {
    ...
    var o,
      ...
      c = r(6),
      p = (function () {
        function t(t, e, r, n, i, o, a, s, l, u, c, p) {
          ;(void 0 === e && (e = {}),
            void 0 === r && (r = {}),
            void 0 === n && (n = {}),
            void 0 === i && (i = {}),
    ...
    var f = (function () {
      function t(t) {
        ...
        ;((this.initMethod = new l.FunctionList()),
          ...
          (this.nodes = {}))
        try {
          for (var a = n(t.slice().reverse()), c = a.next(); !c.done; c = a.next()) {
            var p = c.value
            this.addPackage(p)
          }
        } catch (t) {
        ...
        try {
          for (var f = n(this.configurations), h = f.next(); !h.done; h = f.next()) {
            var d = h.value,
              m = d.item,
              g = d.priority
            this.append(m, g)
      ...
      return (
        ...
        (t.prototype.addFilters = function (t, e) {
          ...
          try {
            for (var h = n(e.postprocessors), d = h.next(); !d.done; d = h.next()) {
              var m = i(d.value, 2),
                g = m[0]
              f = m[1]
  ...
  function (t, e, r) {
    ...
    var h = (function (t) {
      function e(e, r, n) {
        ...
        try {
          for (var c = a(Object.keys(n)), p = c.next(); !p.done; p = c.next()) {
            var f = p.value,
              h = n[f],
              d = o('string' == typeof h ? [h, null] : h, 2),
              m = d[0],
              g = d[1],
              y = new l.Symbol(f, m, g)
            u.add(f, y)
          }
        } catch (t) {
          i = { error: t }
    ...
    var m = (function (t) {
      function e(e, r, n) {
        ...
        try {
          for (var c = a(Object.keys(r)), p = c.next(); !p.done; p = c.next()) {
            var f = p.value,
              h = r[f],
              d = o('string' == typeof h ? [h] : h),
              m = d[0],
              g = d.slice(1),
              y = new l.Macro(f, n[m], g)
            u.add(f, y)
          }
        } catch (t) {
          i = { error: t }
      ...
      return (
        ...
        (e.prototype.parse = function (t) {
          var e = o(t, 2),
            ...
            i = this.lookup(n),
            a = this.parserFor(n)
          return i && a ? a.apply(void 0, s([r, i.symbol], i.args)) || !0 : null
        }),
        e
      )
    })(f)
    ...
    var g = (function (t) {
      ...
      return (
        ...
        (e.prototype.parse = function (t) {
          ...
          var l = r.currentCS
          r.currentCS = '\\' + n
          var u = a.apply(void 0, s([r, '\\' + i.symbol], i.args))
      ...
      return (
        ...
        (e.prototype.parse = function (t) {
          var e = o(t, 2),
            ...
            i = this.lookup(n),
            a = this.parserFor(n)
          return i && a ? (this.parser(r, i.symbol, a, i.args), !0) : null
        }),
        e
      )
    })(m)
  ...
  function (t, e, r) {
      ...
      return (
        ...
        (e.prototype.checkItem = function (e) {
          ...
          if (e.isKind('mml')) {
            if (this.getProperty('primes'))
              if (2 !== n) f.default.setChild(r, 2, this.getProperty('primes'))
                ...
                var i = this.create('node', 'mrow', [this.getProperty('primes'), e.First])
                e.First = i
              }
            return (
          ...
          if (t.prototype.checkItem.call(this, e)[1]) {
            ...
            throw new (c.default.bind.apply(c.default, a([void 0, o[0], o[1]], o.splice(2))))()
          }
          return null
        }),
        (e.errors = Object.assign(Object.create(h.BaseItem.errors), {
        ...
        (e.prototype.checkItem = function (e) {
          ...
          if (r) {
            ...
            if (!e.isKind('fn')) {
              ...
              var i = f.default.getForm(n)
              if (null != i && [0, 0, 1, 1, 0, 1, 1, 0, 0, 0][i[2]]) return [[r, e], !0]
            }
            var o = this.create(
              'token',
              'mo',
    ...
    var k = (function (t) {
      ...
      return (
        ...
        (e.prototype.checkItem = function (t) {
          ...
          return [[(e = this.create('node', 'TeXAtom', [o], { texClass: u.TEXCLASS.REL })), t], !0]
        }),
        e
      )
    })(h.BaseItem)
      ...
      return (
        ...
        (e.prototype.checkItem = function (e) {
          if (e.isClose && !e.isKind('over')) {
            if (e.getProperty('isEntry')) return (this.EndEntry(), this.clearEnv(), h.BaseItem.fail)
            ...
            var i = this.factory.create('mml', n)
            if (this.getProperty('requireClose')) {
              if (e.isKind('close')) return [[i], !0]
    ...
    var L = (function (t) {
      function e(e) {
        ...
        return (i.factory.configuration.tags.start(r[0], r[2], r[1]), i)
      }
      return (
        i(e, t),
        Object.defineProperty(e.prototype, 'kind', {
  ...
  function (t, e, r) {
    ...
    var y = (function (t) {
      function e(r) {
        void 0 === r && (r = {})
        var n = this,
          i = a(l.separateOptions(r, e.OPTIONS, u.FindTeX.OPTIONS), 3),
          o = i[0],
          s = i[1],
          p = i[2]
        ;(n = t.call(this, s) || this).findTeX = n.options.FindTeX || new u.FindTeX(p)
        var f = n.options.packages,
          h = (n.configuration = e.configure(f)),
          g = (n._parseOptions = new d.default(h, [n.options, m.TagsFactory.OPTIONS]))
        return (
        ...
        return (
          ...
          (e.prototype.addPattern = function (t, e, r) {
            var n = o(e, 2),
              i = n[0],
              a = n[1]
            ;(t.push(s.quotePattern(i)), (this.end[i] = [a, r, this.endPattern(a)]))
          }),
          ...
          (e.prototype.findEnd = function (t, e, r, n) {
            for (
              var i,
                ...
                u = a[1],
                c = a[2],
                p = (c.lastIndex = r.index + r[0].length),
                f = 0;
              (i = c.exec(t));
            ) {
              if ((i[1] || i[0]) === s && 0 === f)
          ...
          (e.prototype.findMathInString = function (t, e, r) {
            ...
            for (this.start.lastIndex = 0; (n = this.start.exec(r));) {
              if (void 0 !== n[this.env] && this.env) {
                ...
                i =
                  2 === a.length
                    ? l.protoItem('', a.substr(1), '', e, n.index, o)
                    : l.protoItem('', a, '', e, n.index, o, !1)
    ...
    ;(!(function (t) {
      ;((t.cleanStretchy = function (t) {
        var e,
          ...
          i = t.data
        try {
          for (var o = n(i.getList('fixStretchy')), s = o.next(); !s.done; s = o.next()) {
            var l = s.value
            if (a.default.getProperty(l, 'fixStretchy')) {
              var u = a.default.getForm(l)
              u && u[3] && u[3].stretchy && a.default.setAttribute(l, 'stretchy', !1)
              var c = l.parent
              if (!(a.default.getTexClass(l) || (u && u[2]))) {
                var p = i.nodeFactory.create('node', 'TeXAtom', [l])
                ;(c.replaceChild(p, l), p.inheritAttributesFrom(l))
              }
        ...
        (t.cleanAttributes = function (t) {
          t.data.root.walkTree(function (t, e) {
            ...
            if (o)
              try {
                for (var a = n(o.getExplicitNames()), s = a.next(); !s.done; s = a.next()) {
                  var l = s.value
          ...
          try {
            for (var l = n(t.data.getList('mo')), u = l.next(); !u.done; u = l.next()) {
              ...
              if (
                ...
                c.parent &&
                (!c.parent || a.default.isType(c.parent, 'mrow')) &&
                a.default.getTexClass(c) === o.TEXCLASS.REL
              ) {
                for (
                  var p = c.parent,
                    f = void 0,
                    h = p.childNodes,
                    d = h.indexOf(c) + 1,
                    m = a.default.getProperty(c, 'variantForm');
                  d < h.length &&
                  (f = h[d]) &&
                  a.default.isType(f, 'mo') &&
                  a.default.getTexClass(f) === o.TEXCLASS.REL;
                ) {
                  if (m !== a.default.getProperty(f, 'variantForm') || !r(c, f)) {
                    ;(null == c.attributes.getExplicit('rspace') &&
                      a.default.setAttribute(c, 'rspace', '0pt'),
                      null == f.attributes.getExplicit('lspace') &&
                        a.default.setAttribute(f, 'lspace', '0pt'))
                    break
                  }
                  ;(a.default.appendChildren(c, a.default.getChildren(f)),
                    e(['stretchy', 'rspace'], c, f),
                    a.default.setProperties(c, f.getAllProperties()),
                    h.splice(d, 1),
                    (f.parent = null),
      ...
      var e = function (t, e, r) {
        ...
        r = function (t, e) {
          ...
          try {
            for (var c = n(l), p = c.next(); !p.done; p = c.next()) {
              var f = p.value
          ...
          try {
            for (var s = n(t.getList('m' + e + r)), l = s.next(); !l.done; l = s.next()) {
              ...
              if (!c[u[e]] || !c[u[r]]) {
                ...
                ;(a.default.copyAttributes(u, f), p ? p.replaceChild(f, u) : (t.root = f))
              }
            }
          } catch (t) {
            i = { error: t }
          ...
          (t.prototype.Push = function () {
            ...
            try {
              for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
                var c = u.value
                if (c) {
                  var p = a.default.isNode(c) ? this._factory.create('mml', c) : c
                  p.global = this.global
                  var f = i(this.stack.length ? this.Top().checkItem(p) : [null, !0], 2),
                    h = f[0],
                    d = f[1]
                  d &&
                    (h
                      ? (this.Pop(), this.Push.apply(this, o(h)))
                      : (this.stack.push(p),
                        p.env
      ...
      u = (function () {
        function t(t, e) {
          ;(void 0 === e && (e = []),
            ...
            l.defaultOptions.apply(void 0, i([this.options], e)),
  ...
  function (t, e, r) {
    ...
    var a = r(10),
      ...
      u = (function (t) {
        ...
        return (o(e, t), (e.DefaultStackItems = (((i = {})[l.prototype.kind] = l), i)), e)
      })(s.AbstractFactory)
    e.default = u
  },
  function (t, e, r) {
        ...
        return (
          (t.createNode = function (t, e, r, n, i) {
            ...
            if (s === 1 / 0 || -1 === s)
              1 === r.length && r[0].isInferred
                ? a.setChildren(o.default.getChildren(r[0]))
                : a.setChildren(r)
            else {
              for (var l = [], u = 0, c = void 0; (c = r[u]); u++)
                if (c.isInferred) {
                  var p = t.mmlFactory.create('mrow', {}, o.default.getChildren(c))
                  ;(o.default.copyAttributes(c, p), l.push(p))
                } else l.push(c)
              a.setChildren(l)
            }
            return (i && a.appendChild(i), o.default.setProperties(a, n), a)
          }),
          ...
          (t.prototype.create = function (t) {
            ...
            var n = this.factory[t] || this.factory.node,
              o = n.apply(void 0, i([this, e[0]], e.slice(1)))
  ...
  function (t, e, r) {
    ...
    ;((e.BaseTags = d),
      (e.BaseConfiguration = a.Configuration.create('base', {
        ...
        items:
          ((i = {}),
          (i[p.StartItem.prototype.kind] = p.StartItem),
          (i[p.StopItem.prototype.kind] = p.StopItem),
          (i[p.OpenItem.prototype.kind] = p.OpenItem),
          (i[p.CloseItem.prototype.kind] = p.CloseItem),
          (i[p.PrimeItem.prototype.kind] = p.PrimeItem),
          (i[p.SubsupItem.prototype.kind] = p.SubsupItem),
          (i[p.OverItem.prototype.kind] = p.OverItem),
          (i[p.LeftItem.prototype.kind] = p.LeftItem),
          (i[p.RightItem.prototype.kind] = p.RightItem),
          (i[p.BeginItem.prototype.kind] = p.BeginItem),
          (i[p.EndItem.prototype.kind] = p.EndItem),
          (i[p.StyleItem.prototype.kind] = p.StyleItem),
          (i[p.PositionItem.prototype.kind] = p.PositionItem),
          (i[p.CellItem.prototype.kind] = p.CellItem),
          (i[p.MmlItem.prototype.kind] = p.MmlItem),
          (i[p.FnItem.prototype.kind] = p.FnItem),
          (i[p.NotItem.prototype.kind] = p.NotItem),
          (i[p.DotsItem.prototype.kind] = p.DotsItem),
          (i[p.ArrayItem.prototype.kind] = p.ArrayItem),
          (i[p.EqnArrayItem.prototype.kind] = p.EqnArrayItem),
          (i[p.EquationItem.prototype.kind] = p.EquationItem),
          i),
        options: {
          maxMacros: 1e3,
          baseURL:
  ...
  function (t, e, r) {
    ...
    function m(t, e) {
      var r = t.stack.env,
        n = r.inRoot
      r.inRoot = !0
      var i = new s.default(e, r, t.configuration),
        o = i.mml(),
        a = i.stack.global
    ...
    ;((h.Open = function (t, e) {
      ...
      (h.Superscript = function (t, e) {
        ...
        var l = t.stack.Top()
        l.isKind('prime')
          ? ((s = (r = n(l.Peek(2), 2))[0]), (i = r[1]), t.stack.Pop())
          : (s = t.stack.Prev()) || (s = t.create('token', 'mi', {}, ''))
        var u = o.default.getProperty(s, 'movesupsub'),
          c = o.default.isType(s, 'msubsup') ? s.sup : s.over
        if (
          ...
          throw new a.default('DoubleExponent', 'Double exponent: use braces to clarify')
        ;((o.default.isType(s, 'msubsup') && !o.default.isType(s, 'msup')) ||
          ...
          t.Push(
            t.itemFactory
              .create('subsup', s)
              .setProperties({ position: c, primes: i, movesupsub: u }),
          ))
      }),
      (h.Subscript = function (t, e) {
        ...
        l.isKind('prime')
          ...
          : (s = t.stack.Prev()) || (s = t.create('token', 'mi', {}, ''))
        var u = o.default.getProperty(s, 'movesupsub'),
          c = o.default.isType(s, 'msubsup') ? s.sub : s.under
        if (
          (o.default.isType(s, 'msubsup') &&
            !o.default.isType(s, 'msup') &&
          ...
          throw new a.default('DoubleSubscripts', 'Double subscripts: use braces to clarify')
        ;((o.default.isType(s, 'msubsup') && !o.default.isType(s, 'msup')) ||
          (u
            ? ((!o.default.isType(s, 'munderover') ||
                o.default.isType(s, 'mover') ||
      ...
      (h.SetFont = function (t, e, r) {
        t.stack.env.font = r
      }),
      (h.SetStyle = function (t, e, r, n, i) {
        ;((t.stack.env.style = r),
          (t.stack.env.level = i),
          t.Push(
            t.itemFactory
      ...
      (h.Limits = function (t, e, r) {
        ...
        if (
          !n ||
          (o.default.getTexClass(o.default.getCoreMO(n)) !== c.TEXCLASS.OP &&
            null == o.default.getProperty(n, 'movesupsub'))
        )
          throw new a.default('MisplacedLimits', '%1 is allowed only on operators', t.currentCS)
        var i,
          s = t.stack.Top()
        ;(o.default.isType(n, 'munderover') && !r
          ? ((i = t.create('node', 'msubsup')), o.default.copyChildren(n, i), (n = s.Last = i))
          : o.default.isType(n, 'msubsup') &&
            r &&
            ((i = t.create('node', 'munderover')), o.default.copyChildren(n, i), (n = s.Last = i)),
      ...
      (h.Over = function (t, e, r, n) {
        ...
        ;(r || n
          ...
          : e.match(/withdelims$/) &&
            (i.setProperty('open', t.GetDelimiter(e)), i.setProperty('close', t.GetDelimiter(e))),
          e.match(/^\\above/)
      ...
      (h.Sqrt = function (t, e) {
        ...
        var i = new s.default(n, t.stack.env, t.configuration).mml()
        ;((i = r ? t.create('node', 'mroot', [i, m(t, r)]) : t.create('node', 'msqrt', [i])),
          t.Push(i))
      }),
      (h.Root = function (t, e) {
      ...
      (h.MoveRoot = function (t, e, r) {
        if (!t.stack.env.inRoot)
          throw new a.default('MisplacedMoveRoot', '%1 can appear only within a root', t.currentCS)
        if (t.stack.global[r])
          throw new a.default('MultipleMoveRoot', 'Multiple use of %1', t.currentCS)
        var n = t.GetArgument(e)
        if (!n.match(/-?[0-9]+/))
          throw new a.default('IntegerArg', 'The argument to %1 must be an integer', t.currentCS)
        ;('-' !== (n = parseInt(n, 10) / 15 + 'em').substr(0, 1) && (n = '+' + n),
          (t.stack.global[r] = n))
      }),
      (h.Accent = function (t, e, r, n) {
        var i = t.ParseArg(e),
          a = u.default.getFontDef(t)
        a.accent = !0
        var s = o.default.createEntity(r),
          l = t.create('token', 'mo', a, s)
        o.default.setAttribute(l, 'stretchy', !!n)
        var c = o.default.isEmbellished(i) ? o.default.getCoreMO(i) : i
        o.default.isType(c, 'mo') && o.default.setProperties(c, { movablelimits: !1 })
        var p = t.create('node', 'munderover')
        ;(o.default.setChild(p, 0, i), o.default.setChild(p, 1, null), o.default.setChild(p, 2, l))
        var f = t.create('node', 'TeXAtom', [p])
        t.Push(f)
      }),
      (h.UnderOver = function (t, e, r, n, i) {
        var a,
          s = t.ParseArg(e),
        ...
        ;((a = t.create('token', 'mo', { stretchy: !0, accent: !i }, p)),
          o.default.setChild(u, 'o' === e.charAt(1) ? u.over : u.under, a))
        var f = u
        ;(n && (f = t.create('node', 'TeXAtom', [u], { texClass: c.TEXCLASS.OP, movesupsub: !0 })),
      ...
      (h.Underset = function (t, e) {
        ...
        ;(o.default.isType(n, 'mo') || o.default.getProperty(n, 'movablelimits')) &&
          o.default.setProperties(n, { movablelimits: !1 })
        var i = t.create('node', 'munder', [n, r])
        t.Push(i)
      }),
      (h.TeXAtom = function (t, e, r) {
        ...
        if (r === c.TEXCLASS.OP) {
          ...
          var u = t.GetArgument(e),
            p = u.match(/^\s*\\rm\s+([a-zA-Z0-9 ]+)$/)
          ;(p
            ? ((a.mathvariant = l.TexConstant.Variant.NORMAL),
              (i = t.create('token', 'mi', a, p[1])))
            : ((o = new s.default(u, t.stack.env, t.configuration).mml()),
      ...
      (h.MmlToken = function (t, e) {
        ...
        if (!r || !r.isToken) throw new a.default('NotMathMLToken', '%1 is not a token element', n)
        for (; '' !== i;) {
          var c = i.match(/^([a-z]+)\s*=\s*('[^']*'|"[^"]*"|[^ ,]*)\s*,?\s*/i)
          if (!c) throw new a.default('InvalidMathMLAttr', 'Invalid MathML attribute: %1', i)
          if (!r.attributes.hasDefault(c[1]) && !d[c[1]])
            throw new a.default(
          ...
          var p = u.default.MmlFilterAttribute(t, c[1], c[2].replace(/^(['"])(.*)\1$/, '$2'))
          ;(p &&
      ...
      (h.Phantom = function (t, e, r, n) {
        ...
        ;(r || n) &&
          ...
          n && (o.default.setAttribute(i, 'height', 0), o.default.setAttribute(i, 'depth', 0)),
          r && o.default.setAttribute(i, 'width', 0))
        var a = t.create('node', 'TeXAtom', [i])
        t.Push(a)
      }),
      ...
      (h.rule = function (t, e) {
        ...
        ;(r &&
          ...
          r.match(/^-/)
            ? (o.default.setAttribute(a, 'height', r),
              o.default.setAttribute(a, 'depth', '+' + r.substr(1)))
            : o.default.setAttribute(a, 'height', '+' + r)),
          t.Push(a))
      }),
      (h.MakeBig = function (t, e, r, n) {
        var i = String((n *= 1.411764705882353)).replace(/(\.\d\d\d).+/, '$1') + 'em',
      ...
      (h.BuildRel = function (t, e) {
        ...
        ;(o.default.setChild(i, 0, n), o.default.setChild(i, 1, null), o.default.setChild(i, 2, r))
        var a = t.create('node', 'TeXAtom', [i], { texClass: c.TEXCLASS.REL })
        t.Push(a)
      }),
      ...
      (h.Dots = function (t, e) {
        ...
        t.Push(t.itemFactory.create('dots').setProperties({ ldots: i, cdots: a }))
      }),
      (h.Matrix = function (t, e, r, n, i, o, s, l, u, c) {
        var p = t.GetNext()
        if ('' === p) throw new a.default('MissingArgFor', 'Missing argument for %1', t.currentCS)
        ...
        ;((f.arraydef = { rowspacing: s || '4pt', columnspacing: o || '1em' }),
          u && f.setProperty('isCases', !0),
          c && (f.setProperty('isNumbered', !0), (f.arraydef.side = c)),
          (r || n) && (f.setProperty('open', r), f.setProperty('close', n)),
          'D' === l && (f.arraydef.displaystyle = !0),
          null != i && (f.arraydef.columnalign = i),
          t.Push(f))
      }),
      (h.Entry = function (t, e) {
        if (
          ...
          for (var r = t.string, n = 0, i = -1, o = t.i, s = r.length; o < s;) {
            var l = r.charAt(o)
            if ('{' === l) (n++, o++)
            else if ('}' === l) 0 === n ? (s = 0) : (0 === --n && i < 0 && (i = o - t.i), o++)
            else {
              if ('&' === l && 0 === n)
                throw new a.default('ExtraAlignTab', 'Extra alignment tab in \\cases text')
              '\\' === l ? (r.substr(o).match(/^((\\cr)[^a-zA-Z]|\\\\)/) ? (s = 0) : (o += 2)) : o++
            }
          }
          var c = r.substr(t.i, o - t.i)
          if (!c.match(/^\s*\\text[^a-zA-Z]/) || i !== c.replace(/\s+$/, '').length - 1) {
            var p = u.default.internalMath(t, c, 0)
            ;(t.PushAll(p), (t.i = o))
          }
        }
      }),
      ...
      (h.CrLaTeX = function (t, e, r) {
        ...
        var h,
          d = t.stack.Top()
        if (d instanceof i.ArrayItem) {
          if (o && d.arraydef.rowspacing) {
            var m = d.arraydef.rowspacing.split(/ /)
            if (!d.getProperty('rowspacing')) {
              var g = u.default.dimen2em(m[0])
              d.setProperty('rowspacing', g)
            }
            for (var y = d.getProperty('rowspacing'); m.length < d.table.length;)
              m.push(u.default.Em(y))
            ;((m[d.table.length - 1] = u.default.Em(Math.max(0, y + u.default.dimen2em(o)))),
              (d.arraydef.rowspacing = m.join(' ')))
          }
        } else
          (o && ((h = t.create('node', 'mspace', [], { depth: o })), t.Push(h)),
            (h = t.create('node', 'mspace', [], { linebreak: l.TexConstant.LineBreak.NEWLINE })),
            t.Push(h))
      }),
      ...
      (h.HFill = function (t, e) {
        ...
        if (!(r instanceof i.ArrayItem))
          throw new a.default('UnsupportedHFill', 'Unsupported use of %1', t.currentCS)
        r.hfill.push(r.Size())
      }),
      (h.BeginEnd = function (t, e) {
        var r = t.GetArgument(e)
        if (r.match(/\\/i)) throw new a.default('InvalidEnv', "Invalid environment name '%1'", r)
      ...
      (h.Array = function (t, e, r, n, i, o, a, s, l) {
        ...
        return (
          (c.arraydef = { columnalign: i, columnspacing: o || '1em', rowspacing: a || '4pt' }),
          u.match(/[|:]/) &&
      ...
      (h.EqnArray = function (t, e, r, n, i, o) {
        ;(t.Push(e),
      ...
      (h.HandleNoTag = function (t, e) {
        t.tags.notag()
      }),
      (h.HandleLabel = function (t, e) {
        var r = t.GetArgument(e)
        if ('' !== r && !t.tags.refUpdate) {
          if (t.tags.label) throw new a.default('MultipleCommand', 'Multiple %1', t.currentCS)
          if (
            ((t.tags.label = r),
            (t.tags.allLabels[r] || t.tags.labels[r]) && !t.options.ignoreDuplicateLabels)
          )
            throw new a.default('MultipleLabel', "Label '%1' multiply defined", r)
      ...
      (h.HandleRef = function (t, e, r) {
        ...
        i || (t.tags.refUpdate || (t.tags.redo = !0), (i = new p.Label()))
        var o = i.tag
        r && (o = t.tags.formatTag(o))
        var a = t.create('node', 'mrow', u.default.internalMath(t, o), {
          href: t.tags.formatUrl(i.id, t.options.baseURL),
          class: 'MathJax_ref',
        })
        t.Push(a)
      }),
      (h.Macro = function (t, e, r, n, i) {
        if (n) {
          var o = []
          if (null != i) {
            var s = t.GetBrackets(e)
          ...
          r = u.default.substituteArgs(t, o, r)
        }
        if (
    ...
    ;(!(function (t) {
      ;((t.variable = function (t, e) {
        ...
        (t.environment = function (t, e, r, n) {
          var o = n[0],
            a = t.itemFactory.create('begin').setProperties({ name: e, end: o })
          ;((a = r.apply(void 0, i([t, a], n.slice(1)))), t.Push(a))
        }))
    })(o || (o = {})),
      (e.default = o))
  },
  ...
  function (t, e, r) {
    ...
    ;(new n.RegExpMap('letter', a.default.variable, /[a-z]/i),
      ...
      new n.CharacterMap('mathchar0mi', a.default.mathchar0mi, {
        ...
        varsigma: '\u03c2',
        varphi: '\u03c6',
        S: ['\xa7', { mathvariant: i.TexConstant.Variant.NORMAL }],
        aleph: ['\u2135', { mathvariant: i.TexConstant.Variant.NORMAL }],
        hbar: ['\u210f', { variantForm: !0 }],
        imath: '\u0131',
        jmath: '\u0237',
        ell: '\u2113',
        wp: ['\u2118', { mathvariant: i.TexConstant.Variant.NORMAL }],
        Re: ['\u211c', { mathvariant: i.TexConstant.Variant.NORMAL }],
        Im: ['\u2111', { mathvariant: i.TexConstant.Variant.NORMAL }],
        partial: ['\u2202', { mathvariant: i.TexConstant.Variant.ITALIC }],
        infty: ['\u221e', { mathvariant: i.TexConstant.Variant.NORMAL }],
        prime: ['\u2032', { mathvariant: i.TexConstant.Variant.NORMAL, variantForm: !0 }],
        emptyset: ['\u2205', { mathvariant: i.TexConstant.Variant.NORMAL }],
        nabla: ['\u2207', { mathvariant: i.TexConstant.Variant.NORMAL }],
        top: ['\u22a4', { mathvariant: i.TexConstant.Variant.NORMAL }],
        bot: ['\u22a5', { mathvariant: i.TexConstant.Variant.NORMAL }],
        angle: ['\u2220', { mathvariant: i.TexConstant.Variant.NORMAL }],
        triangle: ['\u25b3', { mathvariant: i.TexConstant.Variant.NORMAL }],
        backslash: ['\u2216', { mathvariant: i.TexConstant.Variant.NORMAL, variantForm: !0 }],
        forall: ['\u2200', { mathvariant: i.TexConstant.Variant.NORMAL }],
        exists: ['\u2203', { mathvariant: i.TexConstant.Variant.NORMAL }],
        neg: ['\xac', { mathvariant: i.TexConstant.Variant.NORMAL }],
        lnot: ['\xac', { mathvariant: i.TexConstant.Variant.NORMAL }],
        flat: ['\u266d', { mathvariant: i.TexConstant.Variant.NORMAL }],
        natural: ['\u266e', { mathvariant: i.TexConstant.Variant.NORMAL }],
        sharp: ['\u266f', { mathvariant: i.TexConstant.Variant.NORMAL }],
        clubsuit: ['\u2663', { mathvariant: i.TexConstant.Variant.NORMAL }],
        diamondsuit: ['\u2662', { mathvariant: i.TexConstant.Variant.NORMAL }],
        heartsuit: ['\u2661', { mathvariant: i.TexConstant.Variant.NORMAL }],
        spadesuit: ['\u2660', { mathvariant: i.TexConstant.Variant.NORMAL }],
      }),
      ...
      new n.CommandMap(
        'macros',
        {
          ...
          rm: ['SetFont', i.TexConstant.Variant.NORMAL],
          mit: ['SetFont', i.TexConstant.Variant.ITALIC],
          oldstyle: ['SetFont', i.TexConstant.Variant.OLDSTYLE],
          cal: ['SetFont', i.TexConstant.Variant.CALLIGRAPHIC],
          it: ['SetFont', '-tex-mathit'],
          bf: ['SetFont', i.TexConstant.Variant.BOLD],
          bbFont: ['SetFont', i.TexConstant.Variant.DOUBLESTRUCK],
          scr: ['SetFont', i.TexConstant.Variant.SCRIPT],
          frak: ['SetFont', i.TexConstant.Variant.FRAKTUR],
          sf: ['SetFont', i.TexConstant.Variant.SANSSERIF],
          tt: ['SetFont', i.TexConstant.Variant.MONOSPACE],
          tiny: ['SetSize', 0.5],
          Tiny: ['SetSize', 0.6],
          ...
          ',': ['Spacer', i.TexConstant.Length.THINMATHSPACE],
          ':': ['Spacer', i.TexConstant.Length.MEDIUMMATHSPACE],
          '>': ['Spacer', i.TexConstant.Length.MEDIUMMATHSPACE],
          ';': ['Spacer', i.TexConstant.Length.THICKMATHSPACE],
          '!': ['Spacer', i.TexConstant.Length.NEGATIVETHINMATHSPACE],
          enspace: ['Spacer', '.5em'],
          quad: ['Spacer', '1em'],
          qquad: ['Spacer', '2em'],
          thinspace: ['Spacer', i.TexConstant.Length.THINMATHSPACE],
          negthinspace: ['Spacer', i.TexConstant.Length.NEGATIVETHINMATHSPACE],
          hskip: 'Hskip',
          hspace: 'Hskip',
          kern: 'Hskip',
          mskip: 'Hskip',
          ...
          eqalign: [
            ...
            null,
            'right left',
            i.TexConstant.Length.THICKMATHSPACE,
            '.5em',
            'D',
          ],
          ...
          mathsf: ['Macro', '{\\sf #1}', 1],
          mathtt: ['Macro', '{\\tt #1}', 1],
          textrm: ['HBox', null, i.TexConstant.Variant.NORMAL],
          textit: ['HBox', null, i.TexConstant.Variant.ITALIC],
          textbf: ['HBox', null, i.TexConstant.Variant.BOLD],
          textsf: ['HBox', null, i.TexConstant.Variant.SANSSERIF],
          texttt: ['HBox', null, i.TexConstant.Variant.MONOSPACE],
  ...
  function (t, e, r) {
      ...
      _: {
        input: {
          ...
          tex: {
            ...
            TexError: P,
            TexParser: S,
            base: { BaseConfiguration: x, BaseItems: A, BaseMethods: M },
          },
        },
      },
    })
    ...
    !(function (t) {
      if (MathJax.startup) {
        ;(MathJax.startup.registerConstructor('tex', i.TeX),
        ...
        ;((MathJax.config.tex.packages = t),
          e && Object(O.insert)(MathJax.config.tex, { packages: e }))
      }
    })(['base'])
  },
])
