!(function (t) {
    ...
    var n = r(5),
      ...
      h = (function (t) {
        function e(e) {
          void 0 === e && (e = {})
          var r = this,
            o = i(s.separateOptions(e, c.FindMathML.OPTIONS, u.MathMLCompile.OPTIONS), 3),
            a = o[0],
            n = o[1],
            h = o[2]
          return (
        ...
        return (
          ...
          (e.prototype.compile = function (t, e) {
            ...
            if (
              ...
              var o = this.executeFilters(this.preFilters, t, e, t.math || '<math></math>'),
                a = this.checkForErrors(this.adaptor.parse(o, 'text/' + this.options.parseAs)),
              ...
              ;(1 !== this.adaptor.childNodes(i).length &&
                ...
                'math' !== this.adaptor.kind(r).replace(/^[a-z]+:/, '') &&
                  this.error(
                    'MathML must be formed by a <math> element, not <' + this.adaptor.kind(r) + '>',
                  ))
            }
            return (
          ...
          (e.prototype.checkForErrors = function (t) {
            ...
            return (
              e &&
                ('' === this.adaptor.textContent(e) && this.error('Error processing MathML'),
      ...
      l = (function (t) {
        ...
        return (
          ...
          (e.prototype.findMath = function (t) {
            ...
            return (
              'html' === this.adaptor.kind(r) && 0 === e.size && this.findMathNS(t, e),
              this.processMath(e)
            )
          }),
          (e.prototype.findMathNodes = function (t, e) {
            var r, o
            try {
              for (var a = i(this.adaptor.tags(t, 'math')), n = a.next(); !n.done; n = a.next()) {
                var s = n.value
                e.add(s)
              }
            } catch (t) {
          ...
          (e.prototype.findMathPrefixed = function (t, e) {
            ...
            try {
              for (var c = i(this.adaptor.allAttributes(l)), u = c.next(); !u.done; u = c.next()) {
                var h = u.value
                if ('xmlns:' === h.name.substr(0, 6) && h.value === s) {
                  var p = h.name.substr(6)
                  try {
                    for (
                      var d = ((a = void 0), i(this.adaptor.tags(t, p + ':math'))), f = d.next();
                      !f.done;
                      f = d.next()
                    ) {
                      var M = f.value
          ...
          (e.prototype.processMath = function (t) {
            var e,
              ...
              o = []
            try {
              for (var a = i(Array.from(t)), n = a.next(); !n.done; n = a.next()) {
                var s = n.value,
                  l =
                  ...
                  c = { node: s, n: 0, delim: '' },
                  u = { node: s, n: 0, delim: '' }
                o.push({ math: this.adaptor.outerHTML(s), start: c, end: u, display: l })
              }
            } catch (t) {
              e = { error: t }
            } finally {
        ...
        return (
          ...
          (t.prototype.makeNode = function (t) {
            ...
            return (
              'TeXAtom' === c
                ? this.texAtom(d, l, n)
                : l && ((d.texClass = i.TEXCLASS[l]), d.setProperty('texClass', d.texClass)),
          ...
          (t.prototype.addAttributes = function (t, e) {
            var r,
              ...
              i = !1
            try {
              for (var n = a(this.adaptor.allAttributes(e)), s = n.next(); !s.done; s = n.next()) {
                var l = s.value,
                  c = l.name,
                ...
                if ('data-mjx-' === c.substr(0, 9))
                  'data-mjx-alternate' === c
                    ...
                    : 'data-mjx-variant' === c && (t.attributes.set('mathvariant', u), (i = !0))
                else if ('class' !== c) {
                  var h = u.toLowerCase()
                  'true' === h || 'false' === h
          ...
          (t.prototype.addChildren = function (t, e) {
            ...
            if (0 !== t.arity) {
              var i = this.adaptor
              try {
                for (var n = a(i.childNodes(e)), s = n.next(); !s.done; s = n.next()) {
                  var l = s.value,
                    c = i.kind(l)
                  if ('#comment' !== c)
                    if ('#text' === c) this.addText(t, l)
                      ...
                      0 === u.arity &&
                        ...
                        (this.options.fixMisplacedChildren
                          ...
                          : u.mError(
                              'There should not be children for ' + u.kind + ' nodes',
                              this.options.verify,
                              !0,
                            ))
                    }
          ...
          (t.prototype.checkClass = function (t, e) {
            ...
            try {
              for (
                var n = a(this.filterClassList(this.adaptor.allClasses(e))), s = n.next();
                !s.done;
                s = n.next()
              ) {
                var l = s.value
                'MJX-' === l.substr(0, 4)
                  ? 'MJX-variant' === l
                    ...
                    : 'MJX-TeXAtom' !== l.substr(0, 11) &&
                      t.attributes.set('mathvariant', this.fixCalligraphic(l.substr(3)))
                  : i.push(l)
              }
            } catch (t) {
              r = { error: t }
          ...
          (t.prototype.texAtom = function (t, e, r) {
            ;((t.texClass = i.TEXCLASS[e]),
              ...
              'OP' !== e ||
                r ||
                (t.setProperty('movesupsub', !0), t.attributes.setInherited('movablelimits', !0)))
          }),
  ...
  function (t, e, r) {
    ...
    ;(Object(o.combineWithMathJax)({
      _: { input: { mathml_ts: a, mathml: { FindMathML: i, MathMLCompile: n } } },
    }),
      MathJax.startup &&
        (MathJax.startup.registerConstructor('mml', a.MathML), MathJax.startup.useInput('mml')))
  },
])
