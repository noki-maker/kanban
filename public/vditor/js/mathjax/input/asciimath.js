!(function (t) {
    ...
    var o = i(3),
      ...
      p = (function (t) {
        ...
        return (
          ...
          (e.NAME = 'AsciiMath'),
          (e.OPTIONS = s(s({}, o.AbstractInputJax.OPTIONS), { FindAsciiMath: null })),
          e
        )
      })(o.AbstractInputJax)
    e.AsciiMath = p
        ...
        return (
          ...
          (e.prototype.addPattern = function (t, e, i) {
            var n = s(e, 2),
              a = n[0],
              r = n[1]
            ;(t.push(o.quotePattern(a)), (this.end[a] = [r, i, new RegExp(o.quotePattern(r), 'g')]))
          }),
          ...
          (e.prototype.findMath = function (t) {
            var e = []
            if (this.hasPatterns)
              for (var i = 0, n = t.length; i < n; i++) this.findMathInString(e, i, t[i])
            return e
          }),
    ...
    ;((e.MathJax = l),
        ...
        ;((e.Object = n({
          ...
          Init: function (t) {
            ...
            return 1 === t.length && t[0] === i
              ? e
              : (e instanceof t.callee || (e = new t.callee(i)), e.Init.apply(e, t) || e)
          },
      ...
      (function (t) {
        ...
        var i = function (t) {
          ...
          for (var n in i.prototype)
            i.prototype.hasOwnProperty(n) && (e[n] = void 0 !== t[n] ? t[n] : i.prototype[n])
        ...
        var n = function (t) {
            ...
            if ((a('var __TeSt_VaR__ = 1'), u.__TeSt_VaR__))
              ...
              a = u.execScript
                ...
                : function (t) {
                    ...
                    ;(n.appendChild(p.createTextNode(t)), i.appendChild(n), i.removeChild(n))
                    var a = e.__result
          ...
          r = function (t, e) {
            ...
            if (t instanceof Array) {
              ...
              if ('function' == typeof t[0]) return i({ hook: t[0], data: t.slice(1) })
              if ('function' == typeof t[1])
                return i({ hook: t[1], object: t[0], data: t.slice(2) })
            } else {
              if ('string' == typeof t) return (s && s(), i({ hook: a, data: [t] }))
          ...
          d = function (t) {
            ;(t = r(t)).pending = 0
            for (var e = 1, i = arguments.length; e < i; e++) arguments[e] && o(arguments[e], t)
            if (0 === t.pending) {
              var a = t()
              n(a) && (t = a)
            }
          ...
          m = l.Object.Subclass({
            ...
            Remove: function (t) {
              for (var e = 0, i = this.hooks.length; e < i; e++)
                if (this.hooks[e] === t)
                  return void (this.running ? this.remove.push(e) : this.hooks.splice(e, 1))
            },
            Execute: function () {
              var t = [{}]
              this.running = !0
          ...
          f = e.Object.Subclass({
            ...
            Push: function () {
              for (var t, e = 0, i = arguments.length; e < i; e++)
                ((t = r(arguments[e])) !== arguments[e] || t.called || (t = r(['wait', this, t])),
                  this.queue.push(t))
          ...
          g = f.Subclass(
            {
              ...
              Post: function (t, e, i) {
                if (((e = r(e)), this.posting || this.pending)) this.Push(['Post', this, t, e, i])
                else {
                  ;((this.callback = e),
                    e.reset(),
              ...
              MessageHook: function (t, e, i) {
                ;((e = r(e)),
                  this.hooks || ((this.hooks = {}), this.Interest(['ExecuteHooks', this])),
        ...
        ;((e.Callback = e.CallBack = r),
          ...
          (e.Callback.ExecuteHooks = function (t, e, i) {
            if (!t) return null
            ;(t instanceof Array || (t = [t]), e instanceof Array || (e = null == e ? [] : [e]))
      ...
      (function (t) {
        ...
        var i = 'Apple Computer, Inc.' === h.vendor && void 0 === h.vendorSub,
          ...
          a = [],
          s = function () {
            for (var t = 0, i = a.length; t < i; t++) e.Ajax.head.removeChild(a[t])
            a = []
          },
          r = { MathJax: '' }
        e.Ajax = {
          ...
          fileURL: function (t) {
            ...
            return (
              e && e[1] in r && (t = (r[e[1]] || this.config.root) + t.substr(e[1].length + 2)), t
            )
          },
          fileName: function (t) {
            var e = this.config.root
            if (t.substr(0, e.length) === e) t = '[MathJax]' + t.substr(e.length)
            else
              for (var i in r)
                if (r.hasOwnProperty(i) && r[i] && t.substr(0, r[i].length) === r[i]) {
          ...
          Require: function (t, i) {
            ...
            if (((i = e.Callback(i)), t instanceof Object))
              for (var a in t) t.hasOwnProperty(a) && ((n = a.toUpperCase()), (t = t[a]))
          ...
          LoadHook: function (t, i, n) {
            ...
            return (
              (t = this.fileURL(t)), this.loaded[t] ? i(this.loaded[t]) : this.addHook(t, i, n), i
            )
          },
          ...
          removeHook: function (t) {
            this.loadHooks[t.file] &&
              ...
              this.loadHooks[t.file].hooks.length || delete this.loadHooks[t.file])
          },
          Preloading: function () {
            for (var t = 0, e = arguments.length; t < e; t++) {
              var i = this.fileURL(arguments[t])
              this.loading[i] || this.loaded[i] || (this.loading[i] = { preloaded: !0 })
            }
          },
          loader: {
            JS: function (t, i) {
          ...
          timer: {
            create: function (t, a) {
              return (
                (t = e.Callback(t)),
                ('STYLE' === a.nodeName && a.styleSheet && void 0 !== a.styleSheet.cssText) ||
                (u.chrome && 'LINK' === a.nodeName)
                  ? t(this.STATUS.OK)
                  : i
                    ? this.timer.start(this, [this.timer.checkSafari2, n++, t], this.styleDelay)
                    : this.timer.start(this, [this.timer.checkLength, a, t], this.styleDelay),
                t
              )
            },
            ...
            return (
              i && !i.preloaded
                ? (e.Message.Clear(i.message),
                  ...
                  i.script && (0 === a.length && setTimeout(s, 0), a.push(i.script)),
          ...
          loadError: function (t) {
            ;(e.Message.Set(['LoadFailed', 'File failed to load: %1', t], null, 2e3),
          ...
          StyleString: function (t) {
            ...
            for (e in t)
              if (t.hasOwnProperty(e))
                ...
                else if ('@media' === e.substr(0, 6)) n += e + ' {' + this.StyleString(t[e]) + '}\n'
                else if (null != t[e]) {
                  for (var s in ((i = []), t[e]))
                    t[e].hasOwnProperty(s) && null != t[e][s] && (i[i.length] = s + ': ' + t[e][s])
                  n += e + ' {' + i.join('; ') + '}\n'
                }
            return n
          },
        ...
        Element: function (t, e, i) {
          ...
          if (e) {
            if (e.hasOwnProperty('style')) {
              var s = e.style
              for (n in ((e.style = {}), s))
                s.hasOwnProperty(n) && (e.style[n.replace(/-([a-z])/g, this.ucMatch)] = s[n])
            }
            for (n in (l.Hub.Insert(a, e), e))
              ('role' !== n && 'aria-' !== n.substr(0, 5)) || a.setAttribute(n, e[n])
          }
          if (i) {
      ...
      (l.Localization = {
        ...
        _: function (t, e) {
          return e instanceof Array
            ...
            : this.processString(this.lookupPhrase(t, e), [].slice.call(arguments, 2))
        },
        processString: function (t, e, i) {
          ...
          for (n = 1, a = s.length; n < a; n += 2) {
            var r = s[n].charAt(0)
            if (r >= '0' && r <= '9')
              ((s[n] = e[s[n] - 1]), 'number' == typeof s[n] && (s[n] = this.number(s[n])))
            else if ('{' === r)
                ...
                if (o)
                  if ('plural' === o[1]) {
                    ...
                    if (void 0 === l) s[n] = '???'
                      ...
                      l = this.plural(l) - 1
                      var u = o[3].replace(/(^|[^%])(%%)*%\|/g, '$1$2%\uefef').split(/\|/)
                      l >= 0 && l < u.length
                        ? (s[n] = this.processString(u[l].replace(/\uEFEF/g, '|'), e, i))
                        : (s[n] = '???')
                    }
                  } else s[n] = '%' + s[n]
              }
          ...
          for (n = 0; n < a; n++)
            ((p += s[n]),
              ++n < a &&
                (s[n] instanceof Array ? (h.push(p), (h = h.concat(s[n])), (p = '')) : (p += s[n])))
          return ('' !== p && h.push(p), h)
        },
        ...
        processMarkdown: function (t, e, i) {
          for (
            var n, a = [], s = t.split(this.markdownPattern), r = s[0], o = 1, l = s.length;
            o < l;
            o += 8
          )
            (s[o + 1]
              ? ((n = this.processString(s[o + 2], e, i)) instanceof Array || (n = [n]),
              ...
              : s[o + 3]
                ? ((n = this.processString(
                  ...
                  (n = ['code', {}, n]))
                : s[o + 5]
                  ? ((n = this.processString(s[o + 5], e, i)) instanceof Array || (n = [n]),
                    (n = ['a', { href: this.processString(s[o + 6], e), target: '_blank' }, n]))
                  : ((r += s[o]), (n = null)),
        ...
        concatString: function (t, e, i, n) {
          return (
            '' != e &&
              ((e = this.processString(e, i, n)) instanceof Array || (e = [e]), (t = t.concat(e))),
            t
          )
        },
        lookupPhrase: function (t, e, i) {
          ;(i || (i = '_'), t instanceof Array && ((i = t[0] || '_'), (t = t[1] || '')))
        ...
        loadDomain: function (t, e) {
          ...
          if (n) {
            ...
            if (n.domains && t in n.domains) {
              var a = n.domains[t]
              if (!a.isLoaded && (i = this.loadFile(t, a))) return l.Callback.Queue(i).Push(e)
            }
          }
          return l.Callback(e)()
        },
      ...
      (l.Message = {
        ...
        filterText: function (t, e, i) {
          return (
            'simple' === l.Hub.config.messageStyle &&
              ('LoadFile' === i
                ? (this.loading || (this.loading = this.localize('Loading') + ' '),
                  (t = this.loading),
                  (this.loading += '.'))
                : 'ProcessMath' === i
                  ? (this.processing || (this.processing = this.localize('Processing') + ' '),
                    (t = this.processing),
                    (this.processing += '.'))
                  : 'TypesetMath' === i &&
                    (this.typesetting || (this.typesetting = this.localize('Typesetting') + ' '),
                    (t = this.typesetting),
                    (this.typesetting += '.'))),
            t
          )
        ...
        Set: function (t, e, i) {
          l.debug &&
            (Array.isArray(t) && (t = l.Localization._.apply(l.Localization, t)),
      ...
      (l.Hub = {
        ...
        CombineConfig: function (t, e) {
          for (var i, n, a = this.config, s = 0, r = (t = t.split(/\./)).length; s < r; s++)
            (a[(i = t[s])] || (a[i] = {}), (n = a), (a = a[i]))
          return ((n[i] = a = this.Insert(e, a)), a)
        },
        Register: {
          PreProcessor: function () {
            return l.Hub.preProcessors.Add.apply(l.Hub.preProcessors, arguments)
          },
          MessageHook: function () {
            return l.Hub.signal.MessageHook.apply(l.Hub.signal, arguments)
          },
          StartupHook: function () {
            return l.Hub.Startup.signal.MessageHook.apply(l.Hub.Startup.signal, arguments)
          },
          LoadHook: function () {
        ...
        setRenderer: function (t, e) {
          if (t) {
            if (l.OutputJax[t]) {
              ;((this.config.menuSettings.renderer = t), null == e && (e = 'jax/mml'))
              var i = this.outputJax
              return i[e] && i[e].length && t !== i[e][0].id
                ? (i[e].unshift(l.OutputJax[t]), this.signal.Post(['Renderer Selected', t]))
                : null
            }
      ...
      (l.Extension = {}),
      (l.Hub.Startup = { queue: l.Callback.Queue(), signal: l.Callback.Signal('Startup') }),
      ...
      (o = l.Object.Subclass(
        {
          ...
          Augment: function (t, e) {
            ...
            if (null != t) {
              for (var s in t)
                t.hasOwnProperty(s) &&
                  ('function' == typeof t[s] ? i.protoFunction(s, t[s]) : (n[s] = t[s]))
          ...
          Translate: function (t, e) {
            throw Error(
              this.directory + '/' + this.JAXFILE + ' failed to define the Translate() method',
            )
          },
          Register: function (t) {},
          Config: function () {
          ...
          Startup: function () {},
          loadComplete: function (t) {
            if ('config.js' === t) return s.loadComplete(this.directory + '/' + t)
            var e = r.Queue()
            return (
              e.Push(
        ...
        { id: 'Jax', version: '2.6.0', directory: n + '/jax', extensionDir: n + '/extensions' },
      )),
      ...
      (i.ElementJax = o.Subclass(
        {
          ...
          Text: function (t, e) {
            ...
            return (i.HTML.setScript(n, t), (n.MathJax.state = this.STATE.UPDATE), a.Update(n, e))
          },
          ...
          Remove: function (t) {
            ;(this.hover && this.hover.clear(this),
              ...
              t || (a.signal.Post(['Remove Math', this.inputID]), this.Detach()))
          },
            ...
            return (
              t.MathJax.state === this.STATE.UPDATE
                ...
                : ((n = t.MathJax.elementJax = this),
                  t.id
                    ? (this.inputID = t.id)
                    : ((t.id = this.inputID = i.ElementJax.GetID()), (this.newID = 1))),
          ...
          Clone: function (t) {
            var e
            for (e in this)
              this.hasOwnProperty(e) && void 0 === t[e] && 'newID' !== e && delete this[e]
            for (e in t)
              t.hasOwnProperty(e) &&
          ...
          Init: function () {
            if (
              ...
              ;(this.root.display ||
                ...
                ((this.root.display = 'block'), this.root.attrNames.push('display')),
        ...
        ;((t.mbase = MathJax.Object.Subclass(
          {
            type: 'base',
            isToken: !1,
            defaults: { mathbackground: t.INHERIT, mathcolor: t.INHERIT, dir: t.INHERIT },
            noInherit: {},
            ...
            childPosition: function () {
              for (var t = this, e = t.parent; e.notParent;) e = (t = e).parent
              for (var i = 0, n = e.data.length; i < n; i++) if (e.data[i] === t) return i
              return null
            },
            setInherit: function (t) {
              if (t !== this.inherit && null == this.inherit) {
                ...
                for (var e = 0, i = this.data.length; e < i; e++)
                  this.data[e] && this.data[e].setInherit && this.data[e].setInherit(t)
              }
            },
            ...
            getPrevClass: function (t) {
              t && ((this.prevClass = t.Get('texClass')), (this.prevLevel = t.Get('scriptlevel')))
            },
            ...
            texSpacing: function () {
              ...
              return (this.prevLevel > 0 || this.Get('scriptlevel') > 0) && n >= 0
                ? ''
            ...
            childIndex: function (t) {
              if (null != t)
                for (var e = 0, i = this.data.length; e < i; e++) if (t === this.data[e]) return e
            },
            CoreIndex: function () {
              return ((this.inferRow && this.data[0]) || this).childIndex(this.Core())
            },
            hasNewline: function () {
          ...
          },
          {
            ...
            setChildTeXclass: function (t) {
              return (
                this.data[0] &&
                  ((t = this.data[0].setTeXclass(t)), this.updateTeXclass(this.data[0])),
                t
              )
            },
              ...
              ;(this.getPrevClass(e),
                ...
                this.data[0]
                  ? this.isEmbellished() || this.data[0].isa(t.mi)
                    ? ((e = this.data[0].setTeXclass(e)), this.updateTeXclass(this.Core()))
          ...
          (t.mi = t.mbase.Subclass({
            ...
            autoDefault: function (e) {
              if ('mathvariant' === e) {
                ...
                return 1 === i.length ||
                  (2 === i.length && i.charCodeAt(0) >= 55296 && i.charCodeAt(0) < 56320)
                  ? t.VARIANT.ITALIC
                  : t.VARIANT.NORMAL
              }
              return ''
          ...
          (t.mo = t.mbase.Subclass({
            ...
            autoDefault: function (e, i) {
              ...
              if (!n) {
                if ('form' === e)
                  return ((this.useMMLspacing &= ~this.SPACE_ATTR.form), this.getForm())
                for (
                  var a = this.data.join(''),
                    s = [this.Get('form'), t.FORM.INFIX, t.FORM.POSTFIX, t.FORM.PREFIX],
                    r = 0,
                    o = s.length;
                  r < o;
                  r++
                ...
                ;(n || (n = this.CheckRange(a)),
                  !n && i
                    ...
                    : (n || (n = MathJax.Hub.Insert({}, this.defaultDef)),
                      this.parent ? (this.def = n) : (n = MathJax.Hub.Insert({}, n)),
                      (n.form = s[0])))
              }
              return (
            ...
            CheckRange: function (e) {
              ...
              for (var n = 0, a = this.RANGES.length; n < a && this.RANGES[n][0] <= i; n++)
                if (i <= this.RANGES[n][1]) {
                  if (this.RANGES[n][3]) {
                    var s = t.optableDir + '/' + this.RANGES[n][3] + '.js'
                    ;((this.RANGES[n][3] = null), MathJax.Hub.RestartAfter(MathJax.Ajax.Require(s)))
                  }
                  var r = t.TEXCLASSNAMES[this.RANGES[n][2]]
                  return (
                    (r = this.OPTABLE.infix[e] = t.mo.OPTYPES['BIN' === r ? 'BIN3' : r]),
                    this.makeDef(r)
                  )
                }
              return null
            ...
            makeDef: function (e) {
              ;(null == e[2] && (e[2] = this.defaultDef.texClass), e[3] || (e[3] = {}))
            ...
            getForm: function () {
              for (var e = this, i = this.parent, n = this.Parent(); n && n.isEmbellished();)
            ...
            CoreParent: function () {
              for (var e = this; e && e.isEmbellished() && e.CoreMO() === this && !e.isa(t.math);)
                e = e.Parent()
              return e
            },
            CoreText: function (e) {
              ...
              for (
                ;
                (((e.isa(t.mrow) || e.isa(t.TeXAtom) || e.isa(t.mstyle) || e.isa(t.mphantom)) &&
                  1 === e.data.length) ||
                  e.isa(t.munderover)) &&
                e.data[0];
              )
            ...
            remap: function (t, e) {
              return (
                (t = t.replace(/-/g, '\u2212')),
                e &&
                  1 === (t = t.replace(/'/g, '\u2032').replace(/`/g, '\u2035')).length &&
                  (t = e[t] || t),
                t
              )
            },
            setTeXclass: function (e) {
              ...
              return this.useMMLspacing
                ...
                : (i.fence &&
                    !this.texClass &&
                    (i.form === t.FORM.PREFIX && (this.texClass = t.TEXCLASS.OPEN),
                    i.form === t.FORM.POSTFIX && (this.texClass = t.TEXCLASS.CLOSE)),
            ...
            adjustTeXclass: function (e) {
              ...
              if (
                (e
                  ? (!e.autoOP ||
                      (this.texClass !== t.TEXCLASS.BIN && this.texClass !== t.TEXCLASS.REL) ||
                ...
                if (
                  ...
                  if (this.texClass === t.TEXCLASS.BIN) {
                    for (
                      ...
                      n.parent &&
                      n.isEmbellished() &&
                      (1 === n.data.length || ('mrow' !== n.type && n.Core() === i));
                    )
                      ((i = n), (n = n.parent))
                    n.data[n.data.length - 1] === i && (this.texClass = t.TEXCLASS.ORD)
                  }
          ...
          (t.mspace = t.mbase.Subclass({
            ...
            hasNewline: function () {
              return !this.hasDimAttr() && this.Get('linebreak') === t.LINEBREAK.NEWLINE
            },
          })),
          ...
          (t.mrow = t.mbase.Subclass({
            ...
            FirstNonSpace: function () {
              for (var t = 0, e = this.data.length; t < e; t++)
                if (this.data[t] && !this.data[t].isSpacelike()) return this.data[t]
              return null
            },
            LastNonSpace: function () {
              for (var t = this.data.length - 1; t >= 0; t--)
                if (this.data[0] && !this.data[t].isSpacelike()) return this.data[t]
              return null
            },
            Core: function () {
              return this.isEmbellished() && void 0 !== this.core ? this.data[this.core] : this
            },
            CoreMO: function () {
            ...
            setTeXclass: function (e) {
              ...
              if ((!this.open && !this.close) || (e && e.fnOP)) {
                for (i = 0; i < n; i++) this.data[i] && (e = this.data[i].setTeXclass(e))
              ...
              return (this.hasOwnProperty('texClass') || (this.texClass = t.TEXCLASS.INNER), this)
            },
            getAnnotation: function (t) {
              return 1 != this.data.length ? null : this.data[0].getAnnotation(t)
            },
          })),
          ...
          (t.mfenced = t.mbase.Subclass({
            ...
            addFakeNodes: function () {
              ...
              if (
                ...
                '' !== e.open &&
                  (this.SetData(
                    ...
                    t
                      .mo(e.open)
                      .With({ fence: !0, form: t.FORM.PREFIX, texClass: t.TEXCLASS.OPEN }),
                  ),
              ...
              '' !== e.close &&
                (this.SetData(
                  ...
                  t
                    .mo(e.close)
                    .With({ fence: !0, form: t.FORM.POSTFIX, texClass: t.TEXCLASS.CLOSE }),
                ),
            ...
            setTeXclass: function (e) {
              ...
              for (var i = 1, n = this.data.length; i < n; i++)
                (this.data['sep' + i] && (e = this.data['sep' + i].setTeXclass(e)),
                  this.data[i] && (e = this.data[i].setTeXclass(e)))
              return (
          ...
          (t.munderover = t.mbase.Subclass({
            ...
            adjustChild_texprimestyle: function (t) {
              return !(t !== this.base || !this.data[this.over]) || this.Get('texprimestyle')
            },
            setTeXclass: t.mbase.setBaseTeXclasses,
          })),
          ...
          (t.mtable = t.mbase.Subclass({
            ...
            adjustChild_displaystyle: function () {
              return null != this.displaystyle ? this.displaystyle : this.defaults.displaystyle
            },
            inheritFromMe: !0,
            noInherit: {
              mover: { align: !0 },
          ...
          (t.mtr = t.mbase.Subclass({
            ...
            Append: function () {
              for (var e = 0, i = arguments.length; e < i; e++)
                arguments[e] instanceof t.mtd || (arguments[e] = t.mtd(arguments[e]))
              this.SUPER(arguments).Append.apply(this, arguments)
            },
            setTeXclass: t.mbase.setSeparateTeXclasses,
          })),
          ...
          (t.maligngroup = t.mbase.Subclass({
            ...
            defaults: { mathbackground: t.INHERIT, mathcolor: t.INHERIT, groupalign: t.INHERIT },
            inheritFromMe: !0,
            noInherit: { mrow: { groupalign: !0 }, mtable: { groupalign: !0 } },
          })),
          (t.malignmark = t.mbase.Subclass({
            type: 'malignmark',
            defaults: { mathbackground: t.INHERIT, mathcolor: t.INHERIT, edge: t.SIDE.LEFT },
            isSpacelike: function () {
              return !0
            },
          })),
            ...
            getAnnotation: function (t) {
              ...
              if (e)
                for (var i = 0, n = this.data.length; i < n; i++) {
                  ...
                  if (a)
                    for (var s = 0, r = e.length; s < r; s++) if (e[s] === a) return this.data[i]
                }
              return null
            },
          })),
          ...
          (t.math = t.mstyle.Subclass({
            ...
            autoDefault: function (t) {
              return 'displaystyle' === t ? 'block' === this.Get('display') : ''
            },
            linebreakContainer: !0,
            setTeXclass: t.mbase.setChildTeXclass,
            getAnnotation: function (t) {
          ...
          (t.xml = t.mbase.Subclass({
            ...
            Import: function (t) {
              ...
              if (1 === t.nodeType) {
                for (
                  e = document.createElement(t.nodeName), i = 0, n = t.attributes.length;
                  i < n;
                  i++
                ) {
        ...
        t.mo.Augment(
          {
            ...
            OPTABLE: {
              ...
              infix: {
                ...
                '\u2061': i.ORD,
                '\u2062': i.ORD,
                '\u2063': [0, 0, e.ORD, { linebreakstyle: 'after', separator: !0 }],
                '\u2064': i.ORD,
                '\u2190': i.WIDEREL,
                '\u2191': i.RELSTRETCH,
                '\u2192': i.WIDEREL,
                ...
                '*': i.BIN3,
                '+': i.BIN4,
                ',': [0, 3, e.PUNCT, { linebreakstyle: 'after', separator: !0 }],
                '-': i.BIN4,
                '.': [3, 3, e.ORD],
                '/': i.ORD11,
                ':': [1, 2, e.REL],
  ...
  function (t, e) {
    ;((MathJax.InputJax.AsciiMath = MathJax.InputJax({
      ...
      config: { fixphi: !0, useMathMLspacing: !0, displaystyle: !0, decimalsign: '.' },
    })),
  ...
  function (t, e) {
    ...
    ;(!(function (t) {
      var e,
        i = MathJax.Object.Subclass({
          ...
          removeChild: function (t) {
            for (var e = 0, i = this.childNodes.length; e < i && this.childNodes[e] !== t; e++);
            if (e !== i)
              return (
          ...
          replaceChild: function (t, e) {
            for (var i = 0, n = this.childNodes.length; i < n && this.childNodes[i] !== e; i++);
            return (
              i ? (this.childNodes[i - 1].nextSibling = t) : (this.firstChild = t),
        ...
        n = {
          ...
          createElementNS: function (i, n) {
            var a = e[n]()
            return ('mo' === n && t.config.useMathMLspacing && (a.useMMLspacing = 128), a)
          },
      ...
      function p(t) {
        return h ? n.createElement(t) : n.createElementNS('http://www.w3.org/1999/xhtml', t)
      }
      ...
      function m(t, e) {
        var i
        return (
          (i = h ? n.createElement('m:' + t) : n.createElementNS(c, t)), e && i.appendChild(e), i
        )
      }
      var f = [
          '\ud835\udc9c',
        ...
        T = [
          ...
          { input: 'epsi', tag: 'mi', output: '\u03b5', tex: 'epsilon', ttype: 0 },
          { input: 'varepsilon', tag: 'mi', output: '\u025b', tex: null, ttype: 0 },
          ...
          { input: '^^^', tag: 'mo', output: '\u22c0', tex: 'bigwedge', ttype: 7 },
          ...
          { input: 'sube', tag: 'mo', output: '\u2286', tex: 'subseteq', ttype: 0 },
          { input: 'supe', tag: 'mo', output: '\u2287', tex: 'supseteq', ttype: 0 },
          ...
          { input: '<<', tag: 'mo', output: '\u2329', tex: null, ttype: 4 },
          { input: '>>', tag: 'mo', output: '\u232a', tex: null, ttype: 5 },
          { input: '{:', tag: 'mo', output: '{:', tex: null, ttype: 4, invisible: !0 },
          { input: ':}', tag: 'mo', output: ':}', tex: null, ttype: 5, invisible: !0 },
          ...
          { input: ':.', tag: 'mo', output: '\u2234', tex: 'therefore', ttype: 0 },
          { input: ":'", tag: 'mo', output: '\u2235', tex: 'because', ttype: 0 },
          { input: '/_', tag: 'mo', output: '\u2220', tex: 'angle', ttype: 0 },
          { input: '/_\\', tag: 'mo', output: '\u25b3', tex: 'triangle', ttype: 0 },
          { input: "'", tag: 'mo', output: '\u2032', tex: 'prime', ttype: 0 },
          { input: 'tilde', tag: 'mover', output: '~', tex: null, ttype: 1, acc: !0 },
          ...
          { input: 'qquad', tag: 'mo', output: '\xa0\xa0\xa0\xa0', tex: null, ttype: 0 },
          ...
          { input: 'Lim', tag: 'mo', output: 'Lim', tex: null, ttype: 7 },
          { input: 'sin', tag: 'mo', output: 'sin', tex: null, ttype: 1, func: !0 },
          { input: 'cos', tag: 'mo', output: 'cos', tex: null, ttype: 1, func: !0 },
          { input: 'tan', tag: 'mo', output: 'tan', tex: null, ttype: 1, func: !0 },
          { input: 'sinh', tag: 'mo', output: 'sinh', tex: null, ttype: 1, func: !0 },
          { input: 'cosh', tag: 'mo', output: 'cosh', tex: null, ttype: 1, func: !0 },
          { input: 'tanh', tag: 'mo', output: 'tanh', tex: null, ttype: 1, func: !0 },
          { input: 'cot', tag: 'mo', output: 'cot', tex: null, ttype: 1, func: !0 },
          { input: 'sec', tag: 'mo', output: 'sec', tex: null, ttype: 1, func: !0 },
          { input: 'csc', tag: 'mo', output: 'csc', tex: null, ttype: 1, func: !0 },
          { input: 'arcsin', tag: 'mo', output: 'arcsin', tex: null, ttype: 1, func: !0 },
          { input: 'arccos', tag: 'mo', output: 'arccos', tex: null, ttype: 1, func: !0 },
          { input: 'arctan', tag: 'mo', output: 'arctan', tex: null, ttype: 1, func: !0 },
          { input: 'coth', tag: 'mo', output: 'coth', tex: null, ttype: 1, func: !0 },
          { input: 'sech', tag: 'mo', output: 'sech', tex: null, ttype: 1, func: !0 },
          { input: 'csch', tag: 'mo', output: 'csch', tex: null, ttype: 1, func: !0 },
          { input: 'exp', tag: 'mo', output: 'exp', tex: null, ttype: 1, func: !0 },
          {
            input: 'abs',
            tag: 'mo',
            output: 'abs',
          ...
          { input: 'log', tag: 'mo', output: 'log', tex: null, ttype: 1, func: !0 },
          { input: 'ln', tag: 'mo', output: 'ln', tex: null, ttype: 1, func: !0 },
          { input: 'det', tag: 'mo', output: 'det', tex: null, ttype: 1, func: !0 },
          { input: 'dim', tag: 'mo', output: 'dim', tex: null, ttype: 0 },
          { input: 'mod', tag: 'mo', output: 'mod', tex: null, ttype: 0 },
          { input: 'gcd', tag: 'mo', output: 'gcd', tex: null, ttype: 1, func: !0 },
          { input: 'lcm', tag: 'mo', output: 'lcm', tex: null, ttype: 1, func: !0 },
          ...
          { input: 'uarr', tag: 'mo', output: '\u2191', tex: 'uparrow', ttype: 0 },
          { input: 'darr', tag: 'mo', output: '\u2193', tex: 'downarrow', ttype: 0 },
          { input: 'rarr', tag: 'mo', output: '\u2192', tex: 'rightarrow', ttype: 0 },
          { input: '->', tag: 'mo', output: '\u2192', tex: 'to', ttype: 0 },
          { input: '>->', tag: 'mo', output: '\u21a3', tex: 'rightarrowtail', ttype: 0 },
          { input: '->>', tag: 'mo', output: '\u21a0', tex: 'twoheadrightarrow', ttype: 0 },
          { input: '>->>', tag: 'mo', output: '\u2916', tex: 'twoheadrightarrowtail', ttype: 0 },
          { input: '|->', tag: 'mo', output: '\u21a6', tex: 'mapsto', ttype: 0 },
          { input: 'larr', tag: 'mo', output: '\u2190', tex: 'leftarrow', ttype: 0 },
          { input: 'harr', tag: 'mo', output: '\u2194', tex: 'leftrightarrow', ttype: 0 },
          { input: 'rArr', tag: 'mo', output: '\u21d2', tex: 'Rightarrow', ttype: 0 },
          { input: 'lArr', tag: 'mo', output: '\u21d0', tex: 'Leftarrow', ttype: 0 },
          { input: 'hArr', tag: 'mo', output: '\u21d4', tex: 'Leftrightarrow', ttype: 0 },
          ...
          { input: 'stackrel', tag: 'mover', output: 'stackrel', tex: null, ttype: 2 },
          { input: 'overset', tag: 'mover', output: 'stackrel', tex: null, ttype: 2 },
          { input: 'underset', tag: 'munder', output: 'stackrel', tex: null, ttype: 2 },
          { input: '_', tag: 'msub', output: '_', tex: null, ttype: 3 },
          { input: '^', tag: 'msup', output: '^', tex: null, ttype: 3 },
          { input: 'hat', tag: 'mover', output: '^', tex: null, ttype: 1, acc: !0 },
          { input: 'bar', tag: 'mover', output: '\xaf', tex: 'overline', ttype: 1, acc: !0 },
          { input: 'vec', tag: 'mover', output: '\u2192', tex: null, ttype: 1, acc: !0 },
          { input: 'dot', tag: 'mover', output: '.', tex: null, ttype: 1, acc: !0 },
          { input: 'ddot', tag: 'mover', output: '..', tex: null, ttype: 1, acc: !0 },
          { input: 'ul', tag: 'munder', output: '\u0332', tex: 'underline', ttype: 1, acc: !0 },
          {
            input: 'ubrace',
            tag: 'munder',
            output: '\u23df',
          ...
          { input: 'obrace', tag: 'mover', output: '\u23de', tex: 'overbrace', ttype: 15, acc: !0 },
          ...
          { input: 'cancel', tag: 'menclose', output: 'cancel', tex: null, ttype: 1 },
          x,
          {
            input: 'bb',
            tag: 'mstyle',
      ...
      function O(t, e, i) {
        if (0 == i) {
          var n, a
          for (i = -1, n = t.length; i + 1 < n;) t[(a = (i + n) >> 1)] < e ? (i = a) : (n = a)
          return n
        }
      ...
      function L(t) {
        ...
        for (var l = !0; '0' <= i && i <= '9' && a <= t.length;) ((i = t.slice(a, a + 1)), a++)
        if (i == u && '0' <= (i = t.slice(a, a + 1)) && i <= '9')
          for (l = !1, a++; '0' <= i && i <= '9' && a <= t.length;) ((i = t.slice(a, a + 1)), a++)
        return (
          (l && a > 1) || a > 2
            ? ((i = t.slice(0, a - 1)), (n = 'mn'))
            : ((a = 2),
              (n = ('A' > (i = t.slice(0, 1)) || i > 'Z') && ('a' > i || i > 'z') ? 'mo' : 'mi')),
          '-' == i && 3 == S
      ...
      function M(t) {
        ...
        t.hasChildNodes() &&
          (!t.firstChild.hasChildNodes() ||
            ...
            ('(' != (e = t.firstChild.firstChild.nodeValue) && '[' != e && '{' != e) ||
            t.removeChild(t.firstChild),
          !t.lastChild.hasChildNodes() ||
            ('mrow' != t.nodeName && 'M:MROW' != t.nodeName) ||
            (')' != (e = t.lastChild.firstChild.nodeValue) && ']' != e && '}' != e) ||
      ...
      function D(t) {
        ...
        if (null == (e = L((t = R(t, 0)))) || (5 == e.ttype && b > 0)) return [null, t]
        switch ((e.ttype == y && (e = L((t = e.output + R(t, e.input.length)))), e.ttype)) {
          case 7:
          case 0:
            return ((t = R(t, e.input.length)), [m(e.tag, n.createTextNode(e.output)), t])
          case 4:
            return (
              b++,
              ...
              'boolean' == typeof e.invisible && e.invisible
                ? (i = m('mrow', a[0]))
                : ((i = m('mo', n.createTextNode(e.output))), (i = m('mrow', i)).appendChild(a[0])),
              [i, a[1]]
            )
          case 10:
            return (
              ...
              ' ' == (r = t.slice(1, s)).charAt(0) &&
                ((i = m('mspace')).setAttribute('width', '1ex'), o.appendChild(i)),
          ...
          case 1:
            ...
            if ('boolean' == typeof e.func && e.func)
              return '^' == (r = t.charAt(0)) ||
                ...
                : ((i = m('mrow', m(e.tag, n.createTextNode(e.output)))).appendChild(a[0]),
                  [i, a[1]])
            if ((M(a[0]), 'sqrt' == e.input)) return [m(e.tag, a[0]), a[1]]
            if (void 0 !== e.rewriteleftright)
              return (
                (i = m('mrow', m('mo', n.createTextNode(e.rewriteleftright[0])))).appendChild(a[0]),
                i.appendChild(m('mo', n.createTextNode(e.rewriteleftright[1]))),
                [i, a[1]]
              )
            if ('cancel' == e.input)
              return ((i = m(e.tag, a[0])).setAttribute('notation', 'updiagonalstrike'), [i, a[1]])
            if ('boolean' == typeof e.acc && e.acc)
              return (
                (i = m(e.tag, a[0])).appendChild(m('mo', n.createTextNode(e.output))), [i, a[1]]
              )
            if (!h && void 0 !== e.codes)
              for (s = 0; s < a[0].childNodes.length; s++)
                if ('mi' == a[0].childNodes[s].nodeName || 'mi' == a[0].nodeName) {
                  r =
                    'mi' == a[0].nodeName
            ...
            return ((i = m(e.tag, a[0])).setAttribute(e.atname, e.atval), [i, a[1]])
          case 2:
            if (null == (a = D((t = R(t, e.input.length))))[0])
              ...
              : (M(p[0]),
                'color' == e.input
                  ? ('{' == t.charAt(0)
                    ...
                    [i, p[1]])
                  : (('root' != e.input && 'stackrel' != e.output) || o.appendChild(p[0]),
                    o.appendChild(a[0]),
                    'frac' == e.input && o.appendChild(p[0]),
                    [m(e.tag, o), p[1]]))
          case 3:
            return ((t = R(t, e.input.length)), [m('mo', n.createTextNode(e.output)), t])
          case 6:
            return (
          ...
          case 9:
            return (
              ...
              b--,
              (r = ''),
              null != a[0].lastChild && (r = a[0].lastChild.firstChild.nodeValue),
              '|' == r
                ? ((i = m('mo', n.createTextNode(e.output))),
                  (i = m('mrow', i)).appendChild(a[0]),
                  [i, a[1]])
                : ((i = m('mo', n.createTextNode('\u2223'))), [(i = m('mrow', i)), t])
            )
          default:
            return ((t = R(t, e.input.length)), [m(e.tag, n.createTextNode(e.output)), t])
        }
      ...
      function k(t, e) {
        ...
        } while (((5 != i.ttype && (9 != i.ttype || e)) || 0 == b) && null != i && '' != i.output)
                ...
                for (r = 0; c && r < d; r += 2) {
                  if (
                    ...
                    for (var f = 0; f < a.childNodes.length; f++)
                      ',' == a.childNodes[f].firstChild.nodeValue && (p[r][p[r].length] = f)
                  ...
                  for (r = 0; r < d; r += 2) {
                    for (
                      ...
                      void 0 !== p[r][x] && f == p[r][x]
                        ? (a.removeChild(a.firstChild), g.appendChild(m('mtd', E)), x++)
                        : E.appendChild(a.firstChild)
                    ;(g.appendChild(m('mtd', E)),
                      o.childNodes.length > 2 &&
                        (o.removeChild(o.firstChild), o.removeChild(o.firstChild)),
      ...
      ;((l = !1),
        ...
        t.Augment({
          AM: {
              ...
              if (
                ...
                for (var n = 0, a = T.length; n < a; n++)
                  ('phi' === T[n].input && (T[n].output = '\u03c6'),
                    'varphi' === T[n].input && ((T[n].output = '\u03d5'), (n = a)))
              var s
            ...
            document: n,
            define: function (t, e) {
              ;(T.push({ input: t, tag: 'mo', output: e, tex: null, ttype: y }), v())
            },
      ...
      (i = MathJax.InputJax.AsciiMath).Augment({
        ...
        formatError: function (t, e, i) {
          ...
          return (MathJax.Hub.signal.Post(['AsciiMath Jax - parse error', a, e, i]), n.Error(a))
        },
        Error: function (t) {
    ...
    ;((i = MathJax.ElementJax.mml),
      ...
      i.mbase.Augment({
        ...
        nodeAddAttributes: function (t) {
          var e = 'mstyle' === this.type ? i.math.prototype.defaults : this.defaults,
          ...
          for (var o = 0, l = n.length; o < l; o++)
            (1 !== s[n[o]] || e.hasOwnProperty(n[o])) &&
              ...
              ('true' !== value && 'false' !== value) || (value = 'true' === value),
      ...
      i.msubsup.Augment({
        toMmlNode: function (t) {
          var e =
            null == this.data[this.sub] ? 'msup' : null == this.data[this.sup] ? 'msub' : 'msubsup'
