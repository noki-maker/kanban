!(function (t) {
  ...
  function (t, e, o) {
    ...
    function c(t, e, o, a) {
      ...
      return (
        'mtext' !== e &&
          ...
          (r.default.setProperty(n, 'fixBold', !0), t.configuration.addNode('fixBold', n)),
        n
      )
    }
    function d(t) {
      ...
      try {
        for (var n = a(t.data.getList('fixBold')), l = n.next(); !l.done; l = n.next()) {
          ...
          if (r.default.getProperty(u, 'fixBold')) {
            ...
            ;(null == c
              ? r.default.setAttribute(u, 'mathvariant', i.TexConstant.Variant.BOLD)
    ...
    ;((s[i.TexConstant.Variant.NORMAL] = i.TexConstant.Variant.BOLD),
      ...
      new l.CommandMap('boldsymbol', { boldsymbol: 'Boldsymbol' }, e.BoldsymbolMethods),
      (e.createBoldToken = c),
