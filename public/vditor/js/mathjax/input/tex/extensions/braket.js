!(function (e) {
  ...
  function (e, t, r) {
    ...
    ;(Object.defineProperty(t, '__esModule', { value: !0 }), (t.BraketItem = void 0))
    var n = r(6),
      i = r(2),
      c = r(7),
      u = (function (e) {
        ...
        return (
          ...
          (t.prototype.checkItem = function (t) {
            return t.isKind('close')
              ...
              : t.isKind('mml')
                ? (this.Push(t.toMml()),
                  this.getProperty('single') ? [[this.toMml()], !0] : n.BaseItem.fail)
          ...
          (t.prototype.toMml = function () {
            ...
            var o = { fence: !0, stretchy: !1, symmetric: !0, texClass: i.TEXCLASS.OPEN },
  ...
  function (e, t, r) {
    ...
    ;((i.Macro = a.default.Macro),
      (i.Braket = function (e, t, r, a, o, i) {
        var c = e.GetNext()
        if ('' === c) throw new n.default('MissingArgFor', 'Missing argument for %1', e.currentCS)
        var u = !0
        ;('{' === c && (e.i++, (u = !1)),
          e.Push(
            e.itemFactory
              .create('braket')
              .setProperties({ barmax: i, barcount: 0, open: r, close: a, stretchy: o, single: u }),
          ))
      }),
      (i.Bar = function (e, t) {
        var r = '|' === t ? '|' : '\u2225',
        ...
        if ('braket' !== a.kind || a.getProperty('barcount') >= a.getProperty('barmax')) {
          var n = e.create('token', 'mo', { texClass: o.TEXCLASS.ORD, stretchy: !1 }, r)
          e.Push(n)
        } else {
          if (
            ('|' === r && '|' === e.GetNext() && (e.i++, (r = '\u2225')), a.getProperty('stretchy'))
          ) {
            var i = e.create('node', 'TeXAtom', [], { texClass: o.TEXCLASS.CLOSE })
            ;(e.Push(i),
              a.setProperty('barcount', a.getProperty('barcount') + 1),
              (i = e.create('token', 'mo', { stretchy: !0, braketbar: !0 }, r)),
              e.Push(i),
              (i = e.create('node', 'TeXAtom', [], { texClass: o.TEXCLASS.OPEN })),
              e.Push(i))
          } else {
  ...
  function (e, t, r) {
    ...
    ;(Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.AbstractMmlLayoutNode = MathJax._.core.MmlTree.MmlNode.AbstractMmlLayoutNode),
  ...
  function (e, t, r) {
    'use strict'
    var a
    ;(Object.defineProperty(t, '__esModule', { value: !0 }), (t.BraketConfiguration = void 0))
    var o = r(5),
      n = r(0)
    ;(r(8),
  ...
  function (e, t, r) {
    ...
    Object(a.combineWithMathJax)({
      _: {
        input: { tex: { braket: { BraketConfiguration: o, BraketItems: n, BraketMethods: i } } },
      },
    })
  },
])
