!(function (e) {
    ...
    var n = a(7),
      ...
      c = {
        ...
        arrow: function (e, t) {
          ...
          e.i++
          var l = e.stack.Top()
          ;(l.isKind('array') && !l.Size()) || (c.cell(e, t), (l = e.stack.Top()))
          for (var s, u = l, d = u.table.length % 2 == 1, m = (u.row.length + (d ? 0 : 1)) % 2; m;)
            (c.cell(e, t), m--)
            ...
            if ('>' === a || '<' === a) {
              if (
                ...
                if (((s = e.create('node', 'munderover', [s])), h)) {
                  ...
                  ;(i.default.setAttribute(g, 'voffset', '.1em'), i.default.setChild(s, s.over, g))
                }
                if (b) {
                  var v = new n.default(b, e.stack.env, e.configuration).mml()
                  i.default.setChild(s, s.under, e.create('node', 'mpadded', [v], _))
                }
                e.configuration.options.amscd.hideHorizontalLabels &&
                  (s = e.create('node', 'mpadded', s, { depth: 0, height: '.67em' }))
              }
            } else {
        ...
        cell: function (e, t) {
          ...
          ;((a.table || []).length % 2 == 0 &&
            ...
            e.Push(e.itemFactory.create('cell').setProperties({ isEntry: !0, name: t })))
        },
  ...
  function (e, t, a) {
    'use strict'
    ;(Object.defineProperty(t, '__esModule', { value: !0 }), (t.AmsCdConfiguration = void 0))
    var n = a(3)
    ;(a(4),
  ...
  function (e, t, a) {
    ...
    var n = a(5),
      r = a(6),
      o = a(1)
    ;(new n.EnvironmentMap('amscd_environment', r.default.environment, { CD: 'CD' }, o.default),
      new n.CommandMap(
        'amscd_macros',
  ...
  function (e, t, a) {
    ...
    ;(Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.BaseConfiguration = MathJax._.input.tex.base.BaseConfiguration.BaseConfiguration))
  },
  function (e, t, a) {
    'use strict'
    ;(Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function (e, t, a) {
    ...
    ;(Object(n.combineWithMathJax)({
      _: { input: { tex: { amscd: { AmsCdConfiguration: r, AmsCdMethods: o } } } },
    }),
      (function (e, t, a) {
        var r,
          o,
