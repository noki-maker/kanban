  ...
  function (t, e, a) {
    ...
    var n = {
            ...
            if (_) {
              for (var d = p[s].task, l = 0; l < d.action_.length; l++) {
                ...
                if (u.actions[d.action_[l].type_])
                  m = u.actions[d.action_[l].type_](r, _.match_, d.action_[l].option)
                else {
                  if (!n.actions[d.action_[l].type_])
                    throw [
                      'MhchemBugA',
                      'mhchem bug A. Please report. (' + d.action_[l].type_ + ')',
                    ]
                  m = n.actions[d.action_[l].type_](r, _.match_, d.action_[l].option)
                }
                n.concatArray(c, m)
              }
      ...
      patterns: {
        patterns: {
          ...
          'state of aggregation $': function (t) {
            ...
            return a ? { match_: a[0], remainder: t.substr(a[0].length) } : null
          },
        ...
        findObserveGroups: function (t, e, a, n, o, r, i, c, u, p) {
          ...
          var d = (function (t, e, a) {
            for (var n = 0; e < t.length;) {
              var o = t.charAt(e),
                r = s(t.substr(e), a)
              if (null !== r && 0 === n) return { endMatchBegin: e, endMatchEnd: e + r.length }
              if ('{' === o) n++
              else if ('}' === o) {
                if (0 === n)
        ...
        match_: function (t, e) {
          ...
          if (void 0 === a) throw ['MhchemBugP', 'mhchem bug P. Please report. (' + t + ')']
          if ('function' == typeof a) return n.patterns.patterns[t](e)
          var o = e.match(a)
          return o
            ? { match_: o[2] ? [o[1], o[2]] : o[1] ? o[1] : o[0], remainder: e.substr(o[0].length) }
            : null
        },
      },
      actions: {
        ...
        '1/2': function (t, e) {
          ...
          return (
            ...
            n[3] && ((n[3] = n[3].replace(/\$/g, '')), a.push({ type_: 'tex-math', p1: n[3] })),
            a
          )
        },
        '9,9': function (t, e) {
      ...
      createTransitions: function (t) {
        ...
        for (e in t)
          for (a in t[e])
            for (n = a.split('|'), t[e][a].stateArray = n, o = 0; o < n.length; o++) r[n[o]] = []
        for (e in t)
          for (a in t[e])
            for (n = t[e][a].stateArray || [], o = 0; o < n.length; o++) {
              ...
              if (i.action_) {
                ...
                for (var c = 0; c < i.action_.length; c++)
                  'string' == typeof i.action_[c] && (i.action_[c] = { type_: i.action_[c] })
              } else i.action_ = []
              for (var u = e.split('|'), p = 0; p < u.length; p++)
                if ('*' === n[o]) for (var s in r) r[s].push({ pattern: u[p], task: i })
        ...
        actions: {
          ...
          'charge or bond': function (t, e) {
            if (t.beginsWithBond) {
              var a = []
              return (
                n.concatArray(a, this.output(t)), n.concatArray(a, n.actions.bond(t, e, '-')), a
              )
            }
            t.d = e
          },
          '- after o/d': function (t, e, a) {
            var o = n.patterns.match_('orbital', t.o || ''),
              ...
              c = n.patterns.match_('$one lowercase latin letter$ $', t.o || ''),
              u = '-' === e && ((o && '' === o.remainder) || r || i || c)
            !u || t.a || t.b || t.p || t.d || t.q || o || !i || (t.o = '$' + t.o + '$')
            var p = []
            return (
              u
                ? (n.concatArray(p, this.output(t)), p.push({ type_: 'hyphen' }))
                : ((o = n.patterns.match_('digits', t.d || '')),
                  a && o && '' === o.remainder
                    ? (n.concatArray(p, n.actions['d='](t, e)), n.concatArray(p, this.output(t)))
          ...
          output: function (t, e, a) {
            ...
            for (var c in t) 'parenthesisLevel' !== c && 'beginsWithBond' !== c && delete t[c]
            return o
          },
      ...
      pu: {
        ...
        actions: {
          enumber: function (t, e) {
            var a = []
            return (
              '+-' === e[0] || '+/-' === e[0] ? a.push('\\pm ') : e[0] && a.push(e[0]),
              e[1] &&
                (n.concatArray(a, n.go(e[1], 'pu-9,9')),
                e[2] &&
                  (e[2].match(/[,.]/) ? n.concatArray(a, n.go(e[2], 'pu-9,9')) : a.push(e[2])),
                (e[3] = e[4] || e[3]),
                e[3] &&
                  ((e[3] = e[3].trim()),
        ...
        actions: {
          ...
          output: function (t) {
            ...
            if (t.rm) {
              ...
              e = a && '' === a.remainder ? n.go(a.match_, 'pu') : { type_: 'rm', p1: t.rm }
            }
      ...
      _go2: function (t) {
        ...
        switch (t.type_) {
          case 'chemfive':
            ...
            ;(a.a && (a.a.match(/^[+-]/) && (a.a = '{' + a.a + '}'), (e += a.a + '\\,')),
              (a.b || a.p) &&
                ((e += '{\\vphantom{X}}'),
                (e += '^{\\hphantom{' + (a.b || '') + '}}_{\\hphantom{' + (a.p || '') + '}}'),
                (e += '{\\vphantom{X}}'),
                (e += '^{\\smash[t]{\\vphantom{2}}\\llap{' + (a.b || '') + '}}'),
                (e += '_{\\vphantom{2}\\llap{\\smash[t]{' + (a.p || '') + '}}}')),
              a.o && (a.o.match(/^[+-]/) && (a.o = '{' + a.o + '}'), (e += a.o)),
              'kv' === t.dType
                ...
                : 'oxidation' === t.dType
                  ? (a.d && ((e += '{\\vphantom{X}}'), (e += '^{' + a.d + '}')),
                    a.q && ((e += '{\\vphantom{X}}'), (e += '_{\\smash[t]{' + a.q + '}}')))
                  : (a.q && ((e += '{\\vphantom{X}}'), (e += '_{\\smash[t]{' + a.q + '}}')),
                    a.d && ((e += '{\\vphantom{X}}'), (e += '^{' + a.d + '}'))))
            break
          case 'rm':
          ...
          case 'frac':
            ...
            break
          case 'pu-frac':
            var r = '\\frac{' + o._goInner(t.p1) + '}{' + o._goInner(t.p2) + '}'
          ...
          case 'overset':
            ...
            break
          case 'underset':
            e = '\\underset{' + o._goInner(t.p1) + '}{' + o._goInner(t.p2) + '}'
            break
          case 'underbrace':
            e = '\\underbrace{' + o._goInner(t.p1) + '}_{' + o._goInner(t.p2) + '}'
            break
          case 'color':
            ...
            ;(i.rd || i.rq
              ? '<=>' === t.r || '<=>>' === t.r || '<<=>' === t.r || '<--\x3e' === t.r
                ? ((c = '\\long' + c),
                  ...
                  i.rq && (c = '\\underset{\\lower7mu{' + i.rq + '}}{' + c + '}'),
                  (c = ' {}\\mathrel{' + c + '}{} '))
                : (i.rq && (c += '[{' + i.rq + '}]'),
                  (c = ' {}\\mathrel{\\x' + (c += '{' + i.rd + '}') + '}{} '))
              : (c = ' {}\\mathrel{\\long' + c + '}{} '),
    ...
    function r(t) {}
    function i(t) {}
    ;((e.mhchemParser = n), (e.texify = o), (e.assertNever = r), (e.assertString = i))
  },
  function (t, e, a) {
    'use strict'
    a.r(e)
    var n = a(0),
      o = a(1)
    Object(n.combineWithMathJax)({ _: { input: { tex: { mhchem: { MhchemConfiguration: o } } } } })
  },
])
