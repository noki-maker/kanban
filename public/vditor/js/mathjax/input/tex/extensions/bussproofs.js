!(function (e) {
  ...
  function (e, t, r) {
    ...
    var i = r(10),
      ...
      d = function (e, t) {
        return e.childNodes['up' === t ? 1 : 0].childNodes[0].childNodes[0].childNodes[0]
          .childNodes[0]
      },
      p = function (e, t) {
      ...
      y = function (e, t) {
        return e.childNodes['up' === t ? 0 : 1].childNodes[0].childNodes[0].childNodes[0]
      },
      v = function (e) {
      ...
      M = function (e, r, o, n) {
        ...
        i.default.isType(f, 'mspace')
          ? i.default.setAttribute(
              f,
              'width',
              l.default.Em(l.default.dimen2em(i.default.getAttribute(f, 'width')) + o),
            )
          : ((f = e.nodeFactory.create('node', 'mspace', [], { width: l.default.Em(o) })),
      ...
      w = function (e, r, o, n, a) {
        var i = e.nodeFactory.create('node', 'mspace', [], { width: l.default.Em(a) })
        if ('left' === n) {
      ...
      !(function (e) {
        ...
        if (r)
          for (var o = r.length - 1, n = void 0; (n = r[o]); o--)
            if (t.getProperty(n, 'sequentProcessed')) t.removeProperty(n, 'sequentProcessed')
            else {
              var a = [],
                i = g(n)
              if (1 === t.getProperty(i, 'inference')) {
                for (a.push(n); 1 === t.getProperty(i, 'inference');) {
                  ...
                  ;(t.getProperty(u, 'sequent') &&
                    ((n = u.childNodes[0]), a.push(n), t.setProperty(n, 'sequentProcessed', !0)),
                    (i = l))
                }
                T(e, a)
              }
        ...
        for (var l = a(i), u = l.next(); !u.done; u = l.next()) {
          ...
          if (null != t.getProperty(N, 'inference')) {
            ...
            if (!p && (k = v(s))) {
              var O = P(k)
              if (O) {
                var J = n.nodeFactory.create('node', 'mspace', [], { width: A - j + 'em' })
      ...
      (t.makeBsprAttributes = function (e) {
        e.data.root.walkTree(function (e, t) {
          ...
          ;(e.getPropertyNames().forEach(function (t) {
            !I[t] && t.match(RegExp('^bspr_')) && r.push(t + ':' + e.getProperty(t))
          }),
        ...
        return (
          ...
          (t.prototype.checkItem = function (e) {
            if (e.isKind('end') && 'prooftree' === e.getName()) {
              var t = this.toMml()
              return (u.setProperty(t, 'proof', !0), [[this.factory.create('mml', t), e], !0])
            }
            if (e.isKind('stop'))
              throw new a.default('EnvMissingEnd', 'Missing \\end{%1}', this.getName())
  ...
  function (e, t, r) {
    ...
    var a = r(3),
      ...
      s = function (e, t) {
        ...
        if (!r[0].childNodes[0].childNodes.length) return e.create('node', 'mrow', [])
    ...
    function c(e, t, r, o, n, a, i) {
      ...
      return ((m = e.create('node', 'mrow', s)), u.setProperty(m, 'labelledRule', c), m)
    }
    function d(e, t) {
      if ('$' !== e.GetNext())
        throw new a.default('IllegalUseOfCommand', "Use of %1 does not match it's definition.", t)
      e.i++
      var r = e.GetUpTo(t, '$')
      if (-1 === r.indexOf('\\fCenter'))
        throw new a.default('IllegalUseOfCommand', 'Missing \\fCenter in %1.', t)
      var n = o(r.split('\\fCenter'), 2),
        ...
        v = e.create('node', 'mtable', [y], { columnspacing: '.5ex', columnalign: 'center 2' })
      return (u.setProperty(v, 'sequent', !0), e.configuration.addNode('sequent', y), v)
    }
    ;((f.Inference = function (e, t, r) {
      ...
      if (o.Size() < r) throw new a.default('BadProofTree', 'Proof tree badly specified.')
      var n = o.getProperty('rootAtTop'),
        i = 1 !== r || o.Peek()[0].childNodes.length ? r : 0,
        l = []
      do {
        ;(l.length && l.unshift(e.create('node', 'mtd', [], {})),
          l.unshift(e.create('node', 'mtd', [o.Pop()], { rowalign: n ? 'top' : 'bottom' })),
          r--)
      } while (r > 0)
      ...
      m !== o.getProperty('line') && o.setProperty('currentLine', o.getProperty('line'))
      ...
      (f.InferenceF = function (e, t, r) {
        ...
        var f = e.create('node', 'mtr', l, {}),
          ...
          m = o.getProperty('currentLine')
        m !== o.getProperty('line') && o.setProperty('currentLine', o.getProperty('line'))
        var h = c(e, s, [p], o.getProperty('left'), o.getProperty('right'), m, n)
        ;(o.setProperty('left', null),
          o.setProperty('right', null),
          u.setProperty(h, 'inference', i),
          e.configuration.addNode('inference', h),
  ...
  function (e, t, r) {
    'use strict'
    var o
    ;(Object.defineProperty(t, '__esModule', { value: !0 }), (t.BussproofsConfiguration = void 0))
    var n = r(7),
      a = r(1),
      i = r(0)
    ;(r(11),
