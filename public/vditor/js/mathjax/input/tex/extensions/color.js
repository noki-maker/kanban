!(function (e) {
  ...
  function (e, o, t) {
    ...
    function a(e) {
      var o = '+' + e,
        t = e.replace(/^.*?([a-z]*)$/, '$1')
      return { width: '+' + 2 * parseFloat(o) + t, height: o, depth: o, lspace: e }
    }
    ;((o.ColorMethods = {}),
      (o.ColorMethods.Color = function (e, o) {
        var t = e.GetBrackets(o, ''),
          ...
          a = e.itemFactory.create('style').setProperties({ styles: { mathcolor: n } })
      ...
      (o.ColorMethods.ColorBox = function (e, o) {
        var t = e.GetArgument(o),
          ...
          u = e.create('node', 'mpadded', l, { mathbackground: i.getColor('named', t) })
    ...
    ;((o.ColorModel = i),
      ...
      l.set('RGB', function (e) {
        ...
        try {
          for (var i = r(a), u = i.next(); !u.done; u = i.next()) {
            var d = u.value
            if (!d.match(/^\d+$/)) throw new n.default('InvalidNumber', 'Invalid number')
            var c = parseInt(d)
            if (c > 255)
              throw new n.default(
                'ModelArg2',
  ...
  function (e, o, t) {
    'use strict'
    ;(Object.defineProperty(o, '__esModule', { value: !0 }), (o.ColorConfiguration = void 0))
    var r = t(5),
      n = t(6),
      a = t(0),
      l = t(1)
  ...
  function (e, o, t) {
    ...
    Object(r.combineWithMathJax)({
      _: {
        input: {
          tex: {
            color: { ColorConfiguration: n, ColorConstants: a, ColorMethods: l, ColorUtil: i },
          },
        },
      },
    })
