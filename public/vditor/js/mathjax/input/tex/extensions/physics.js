!(function (t) {
      ...
      c = (function (t) {
        ...
        return (
          ...
          (e.prototype.toMml = function () {
            ...
            a && this.Push(new s.default(a, e.stack.env, e.configuration).mml())
  ...
  function (t, e, a) {
    ...
    ;((m.Quantity = function (t, e, a, r, n, u, m) {
      ...
      if ('\\' === v) {
        if ((t.i++, !(h = t.GetCS()).match(f))) {
          ...
          return (t.Push(c.default.fenced(t.configuration, a, x, r)), void (t.i = g))
        }
        v = t.GetNext()
      }
      var M = d[v]
      if (n && '{' !== v)
        throw new o.default('MissingArgFor', 'Missing argument for %1', t.currentCS)
      if (!M) {
      ...
      if (u) {
        ...
        ;(m && l.default.setAttribute(y, 'mathvariant', m), t.Push(t.itemFactory.create('fn', y)))
      }
      if ('{' === v) {
      ...
      ;(n && ((v = a), (M = r)),
        t.i++,
        t.Push(t.itemFactory.create('auto open').setProperties({ open: v, close: M, big: h })))
    }),
      (m.Eval = function (t, e) {
        var a = t.GetStar(),
          r = t.GetNext()
        ...
        var n = t.GetArgument(e),
          i = '\\left. ' + (a ? '\\smash{' + n + '}' : n) + ' \\vphantom{\\int}\\right|'
    ...
    var b = function (t, e, a, r, n) {
      ...
      if (c) {
        ...
        l && (t.i++, t.Push(t.itemFactory.create('auto open').setProperties({ open: s, close: c })))
      }
    }
    function P(t, e, a) {
      var n = r(t, 3),
    ...
    ;((m.OperatorApplication = function (t, e, a) {
      ...
      (m.Derivative = function (t, e, a, r) {
        ...
        a > 2 && c.length > 2
          ? ((u = '^{' + (c.length - 1) + '}'), (l = !0))
          : null != o && (a > 2 && c.length > 1 && (l = !0), (m = u = '^{' + o + '}'))
        for (
      ...
      (m.XMatrix = function (t, e) {
        ...
        if (1 === s && 1 === c) m = r
          ...
          for (d = 1; d <= s; d++) {
            l = []
            for (var p = 1; p <= c; p++) l.push(r + '_{{' + d + '}{' + p + '}}')
            f.push(l.join(' & '))
          }
          m = f.join('\\\\ ')
        }
  ...
  function (t, e, a) {
    ...
    Object(r.combineWithMathJax)({
      _: {
        input: {
          tex: { physics: { PhysicsConfiguration: n, PhysicsItems: i, PhysicsMethods: o } },
        },
      },
    })
  },
