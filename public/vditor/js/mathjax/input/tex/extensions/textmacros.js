!(function (t) {
  ...
  function (t, e, a) {
    ...
    e.TextMacrosMethods = {
            ...
            case '$':
              if (0 === s && e === r) {
                var i = t.texParser.configuration,
                  c = new n.default(t.string.substr(o, a - o), t.stack.env, i).mml()
      ...
      Emph: function (t, e) {
        var a = '-tex-mathit' === t.stack.env.mathvariant ? 'normal' : '-tex-mathit'
        ...
        return (
          ...
          (e.prototype.saveText = function () {
            if (this.text) {
              var t = this.stack.env.mathvariant,
                e = l.default.internalText(this, this.text, t ? { mathvariant: t } : {})
          ...
          (e.prototype.PushMath = function (t) {
            var e,
              ...
              n = this.stack.env
            try {
              for (var r = o(['mathsize', 'mathcolor']), s = r.next(); !s.done; s = r.next()) {
                var i = s.value
                n[i] &&
          ...
          (e.prototype.addAttributes = function (t) {
            ...
            if (t.isToken)
              try {
                for (
                  var r = o(['mathsize', 'mathcolor', 'mathvariant']), s = r.next();
                  !s.done;
                  s = r.next()
                ) {
                  var i = s.value
                  n[i] && !t.attributes.getExplicit(i) && m.default.setAttribute(t, i, n[i])
                }
              } catch (t) {
                e = { error: t }
              } finally {
  ...
  function (t, e, a) {
    ...
    function l(t, e, a, n) {
      ...
      return (
        ...
        [new c.TextParser(e, n ? { mathvariant: n } : {}, r.parseOptions, a).mml()]
      )
    }
    ;(a(15),
      ...
      r.Configuration.create('textmacros', {
        config: function (t, a) {
          ...
          ;((i.options = a.parseOptions.options),
            ...
            i.packageData.set('textmacros', { parseOptions: i, jax: a, texParser: null }),
  ...
  function (t, e, a) {
    ...
    Object(n.combineWithMathJax)({
      _: {
        input: {
          tex: { textmacros: { TextMacrosConfiguration: r, TextMacrosMethods: o, TextParser: s } },
        },
      },
    })
  },
