      ...
      return (function (t) {
        ...
        return (
          ...
          (e.prototype.assistiveMml = function (t, e) {
            if ((void 0 === e && (e = !1), !(this.state() >= u.STATE.ASSISTIVEMML))) {
              if (!this.isEscaped && (t.options.enableAssistiveMml || e)) {
                ...
                ;(i.setAttribute(this.typesetRoot, 'role', 'presentation'),
                  i.setAttribute(i.firstChild(this.typesetRoot), 'aria-hidden', 'true'),
      ...
      return (
        ((e = (function (t) {
          ...
          return (
            ...
            (e.prototype.assistiveMml = function () {
              ...
              if (!this.processed.isSet('assistive-mml')) {
                try {
                  for (var i = l(this.math), n = i.next(); !n.done; n = i.next()) {
            ...
            (e.prototype.state = function (e, i) {
              return (
                ...
                e < u.STATE.ASSISTIVEMML && this.processed.clear('assistive-mml'),
                this
              )
            }),
            e
          ...
          renderActions: p.expandable(
            r(r({}, t.OPTIONS.renderActions), { assistiveMml: [u.STATE.ASSISTIVEMML] }),
          ),
        })),
        (e.assistiveStyles = {
          'mjx-assistive-mml': {
