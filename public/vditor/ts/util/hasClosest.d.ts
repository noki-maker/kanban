export declare const hasTopClosestByClassName: (
  element: Node,
  className: string,
) => false | HTMLElement
export declare const hasTopClosestByAttribute: (
  element: Node,
  attr: string,
  value: string,
) => false | HTMLElement
...
export declare const hasClosestByAttribute: (
  element: Node,
  attr: string,
  value: string,
) => false | HTMLElement
...
export declare const hasClosestByClassName: (
  element: Node,
  className: string,
) => false | HTMLElement
