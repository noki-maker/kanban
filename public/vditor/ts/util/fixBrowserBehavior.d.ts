export declare const fixGSKeyBackspace: (
  event: KeyboardEvent,
  vditor: IVditor,
  startContainer: Node,
) => boolean
...
export declare const insertAfterBlock: (
  vditor: IVditor,
  event: KeyboardEvent,
  range: Range,
  element: HTMLElement,
...
export declare const insertBeforeBlock: (
  vditor: IVditor,
  event: KeyboardEvent,
  range: Range,
  element: HTMLElement,
...
export declare const listToggle: (
  vditor: IVditor,
  range: Range,
  type: string,
  cancel?: boolean,
...
export declare const listOutdent: (
  vditor: IVditor,
...
export declare const execAfterRender: (
  vditor: IVditor,
  options?: {
...
export declare const fixMarkdown: (
  event: KeyboardEvent,
  vditor: IVditor,
  pElement: HTMLElement | false,
  range: Range,
...
export declare const insertRowAbove: (
  vditor: IVditor,
  range: Range,
...
export declare const deleteColumn: (
  vditor: IVditor,
  range: Range,
  tableElement: HTMLTableElement,
  cellElement: HTMLElement,
...
export declare const fixCodeBlock: (
  vditor: IVditor,
  event: KeyboardEvent,
  codeRenderElement: HTMLElement,
  range: Range,
) => boolean
export declare const fixBlockquote: (
  vditor: IVditor,
  range: Range,
  event: KeyboardEvent,
  pElement: HTMLElement | false,
...
export declare const fixDelete: (
  vditor: IVditor,
  range: Range,
  event: KeyboardEvent,
  pElement: HTMLElement | false,
...
export declare const fixFirefoxArrowUpTable: (
  event: KeyboardEvent,
